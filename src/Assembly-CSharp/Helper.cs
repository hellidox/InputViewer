...
public static class Helper
{
	...
	public static Helper.UintPair NewUintPair(uint \u02B6\u02B2\u02BF\u02BC\u02C1\u02BA\u02B9\u02B2\u02BD\u02BE\u02B8)
	{
		return new Helper.UintPair(\u02B6\u02B2\u02BF\u02BC\u02C1\u02BA\u02B9\u02B2\u02BD\u02BE\u02B8);
	}

	public static Helper.\u02B2\u02B8\u02C1\u02BF\u02B7\u02B4\u02B2\u02B2\u02C0\u02B2\u02BA \u02B8\u02C0\u02BA\u02BB\u02B6\u02BA\u02BA\u02C0\u02B4\u02C1\u02B9(ushort \u02B6\u02B2\u02BF\u02BC\u02C1\u02BA\u02B9\u02B2\u02BD\u02BE\u02B8)
	{
		return new Helper.\u02B2\u02B8\u02C1\u02BF\u02B7\u02B4\u02B2\u02B2\u02C0\u02B2\u02BA(\u02B6\u02B2\u02BF\u02BC\u02C1\u02BA\u02B9\u02B2\u02BD\u02BE\u02B8);
	}
	...
	public static string[] \u02BB\u02B9\u02B3\u02C0\u02C1\u02B2\u02B9\u02B2\u02B7\u02B8\u02B2(string \u02BF\u02B2\u02BE\u02C1\u02B3\u02B5\u02BD\u02B9\u02B9\u02C0\u02BC, string \u02B7\u02C1\u02BA\u02B9\u02BB\u02B7\u02B2\u02B6\u02C0\u02B6\u02BA, SearchOption \u02BE\u02C1\u02B8\u02C0\u02BF\u02BC\u02B8\u02B9\u02BC\u02BD\u02BB)
	{
		...
		if (Helper.\u02BB\u02B6\u02C1\u02B3\u02B5\u02BA\u02BE\u02B2\u02B7\u02B6\u02BD == null)
		{
			Helper.\u02BB\u02B6\u02C1\u02B3\u02B5\u02BA\u02BE\u02B2\u02B7\u02B6\u02BD = new List<string>();
		}
		else
		{
			Helper.\u02BB\u02B6\u02C1\u02B3\u02B5\u02BA\u02BE\u02B2\u02B7\u02B6\u02BD.Clear();
		}
		foreach (string text in enumerable)
		{
			...
			foreach (string text2 in array)
			{
				...
				{
					Helper.\u02BB\u02B6\u02C1\u02B3\u02B5\u02BA\u02BE\u02B2\u02B7\u02B6\u02BD.Add(text);
					break;
				}
			}
		}
		return Helper.\u02BB\u02B6\u02C1\u02B3\u02B5\u02BA\u02BE\u02B2\u02B7\u02B6\u02BD.ToArray();
	}
	...
	public static string \u02BB\u02BD\u02B6\u02B4\u02BE\u02C1\u02B4\u02BD\u02B9\u02C0\u02BC(string[] \u02C1\u02BC\u02BE\u02BC\u02B5\u02BD\u02C0\u02BC\u02BC\u02B9\u02BA, string[] \u02C1\u02B9\u02B8\u02B2\u02BD\u02C1\u02B4\u02B3\u02B6\u02B6\u02B2, int \u02B7\u02BB\u02BB\u02BC\u02C1\u02BC\u02B8\u02B4\u02B2\u02BC\u02B2)
	{
		...
		{
			if (Helper.\u02BB\u02BD\u02B6\u02B4\u02BE\u02C1\u02B4\u02BD\u02B9\u02C0\u02BC(\u02C1\u02BC\u02BE\u02BC\u02B5\u02BD\u02C0\u02BC\u02BC\u02B9\u02BA[i], \u02C1\u02B9\u02B8\u02B2\u02BD\u02C1\u02B4\u02B3\u02B6\u02B6\u02B2, \u02B7\u02BB\u02BB\u02BC\u02C1\u02BC\u02B8\u02B4\u02B2\u02BC\u02B2) != null)
			{
				return Helper.\u02BB\u02BD\u02B6\u02B4\u02BE\u02C1\u02B4\u02BD\u02B9\u02C0\u02BC(\u02C1\u02BC\u02BE\u02BC\u02B5\u02BD\u02C0\u02BC\u02BC\u02B9\u02BA[i], \u02C1\u02B9\u02B8\u02B2\u02BD\u02C1\u02B4\u02B3\u02B6\u02B6\u02B2, \u02B7\u02BB\u02BB\u02BC\u02C1\u02BC\u02B8\u02B4\u02B2\u02BC\u02B2);
			}
		}
		return null;
	}
	...
	public static Helper.GraphicsAPI SupportedGraphicsAPIs()
	{
		...
		if (platform <= RuntimePlatform.WindowsPlayer)
		{
			...
			{
				return Helper.GraphicsAPI.Metal;
			}
			if (platform != RuntimePlatform.WindowsPlayer)
			{
				return Helper.GraphicsAPI.DX11;
			}
		}
		else if (platform != RuntimePlatform.WindowsEditor)
		{
			...
			{
				return Helper.GraphicsAPI.OpenGL | Helper.GraphicsAPI.Vulkan;
			}
			return Helper.GraphicsAPI.DX11;
		}
		return Helper.GraphicsAPI.DX11 | Helper.GraphicsAPI.DX12 | Helper.GraphicsAPI.OpenGL | Helper.GraphicsAPI.Vulkan;
	}

	public static GraphicsDeviceType \u02BA\u02B5\u02BD\u02BF\u02B3\u02B3\u02B6\u02BC\u02BF\u02C0\u02B8(Helper.GraphicsAPI \u02B8\u02C0\u02BA\u02B8\u02B5\u02B2\u02B5\u02BF\u02C0\u02BC\u02BF)
	{
		if (\u02B8\u02C0\u02BA\u02B8\u02B5\u02B2\u02B5\u02BF\u02C0\u02BC\u02BF <= Helper.GraphicsAPI.DX12)
		{
			if (\u02B8\u02C0\u02BA\u02B8\u02B5\u02B2\u02B5\u02BF\u02C0\u02BC\u02BF == Helper.GraphicsAPI.DX11)
			{
		...
		{
			if (\u02B8\u02C0\u02BA\u02B8\u02B5\u02B2\u02B5\u02BF\u02C0\u02BC\u02BF == Helper.GraphicsAPI.Metal)
			{
				return GraphicsDeviceType.Metal;
			}
			if (\u02B8\u02C0\u02BA\u02B8\u02B5\u02B2\u02B5\u02BF\u02C0\u02BC\u02BF == Helper.GraphicsAPI.OpenGL)
			{
				return GraphicsDeviceType.OpenGLCore;
			}
			if (\u02B8\u02C0\u02BA\u02B8\u02B5\u02B2\u02B5\u02BF\u02C0\u02BC\u02BF == Helper.GraphicsAPI.Vulkan)
			{
	...
	public static string \u02BF\u02BD\u02B3\u02B2\u02B2\u02BA\u02B6\u02B2\u02C1\u02B4\u02C1(Helper.GraphicsAPI \u02B8\u02C0\u02BA\u02B8\u02B5\u02B2\u02B5\u02BF\u02C0\u02BC\u02BF)
	{
		if (\u02B8\u02C0\u02BA\u02B8\u02B5\u02B2\u02B5\u02BF\u02C0\u02BC\u02BF <= Helper.GraphicsAPI.DX12)
		{
			if (\u02B8\u02C0\u02BA\u02B8\u02B5\u02B2\u02B5\u02BF\u02C0\u02BC\u02BF == Helper.GraphicsAPI.DX11)
	...
	public static string \u02B9\u02B6\u02C0\u02B9\u02B3\u02BA\u02B8\u02BF\u02B4\u02BE\u02BB(Helper.GraphicsAPI \u02B8\u02C0\u02BA\u02B8\u02B5\u02B2\u02B5\u02BF\u02C0\u02BC\u02BF)
	{
		if (\u02B8\u02C0\u02BA\u02B8\u02B5\u02B2\u02B5\u02BF\u02C0\u02BC\u02BF <= Helper.GraphicsAPI.DX12)
		{
			if (\u02B8\u02C0\u02BA\u02B8\u02B5\u02B2\u02B5\u02BF\u02C0\u02BC\u02BF == Helper.GraphicsAPI.DX11)
	...
	{
		int num = \u02BB\u02C0\u02BF\u02B2\u02B8\u02BF\u02B8\u02B5\u02C0\u02BA\u02C1.IndexOfAny(Helper.\u02C1\u02C0\u02B8\u02C1\u02C0\u02BC\u02B3\u02B5\u02B7\u02B4\u02BD);
		if (num == -1)
		{
			return \u02BB\u02C0\u02BF\u02B2\u02B8\u02BF\u02B8\u02B5\u02C0\u02BA\u02C1;
		}
		...
		checked
		{
			...
			readOnlySpan = Helper.\u02C1\u02C0\u02B8\u02C1\u02C0\u02BC\u02B3\u02B5\u02B7\u02B4\u02BD;
	...
	{
		return LanguageManager.instance.GetString(\u02BF\u02B9\u02B3\u02B6\u02B4\u02BF\u02B4\u02B8\u02B6\u02BD\u02BA ? "Enabled" : "Disabled");
	}
	...
	{
		public bool MoreThanOneBitSet()
		{
			this.Value2 = this.Value1;
			this.Value1 &= this.Value1 - 1U;
			return this.Value1 != 0U || this.Value2 != 0U;
		}
		...
		public void UintPair(uint \u02B6\u02B2\u02BF\u02BC\u02C1\u02BA\u02B9\u02B2\u02BD\u02BE\u02B8)
		{
			this.Value1 = \u02B6\u02B2\u02BF\u02BC\u02C1\u02BA\u02B9\u02B2\u02BD\u02BE\u02B8;
			this.Value2 = \u02B6\u02B2\u02BF\u02BC\u02C1\u02BA\u02B9\u02B2\u02BD\u02BE\u02B8;
		}

		public Helper.UintPair GetThis()
		{
			return this;
		}
	...
	public struct \u02B2\u02B8\u02C1\u02BF\u02B7\u02B4\u02B2\u02B2\u02C0\u02B2\u02BA
	{
		...
		public Helper.\u02B2\u02B8\u02C1\u02BF\u02B7\u02B4\u02B2\u02B2\u02C0\u02B2\u02BA \u02B3\u02B7\u02B6\u02B5\u02C1\u02C1\u02BB\u02B3\u02B3\u02BA\u02B5()
		{
			return this;
		}

		public Helper.\u02B2\u02B8\u02C1\u02BF\u02B7\u02B4\u02B2\u02B2\u02C0\u02B2\u02BA \u02BE\u02C0\u02BA\u02B2\u02BD\u02C1\u02B5\u02B8\u02BC\u02B9\u02BB()
		{
			return this;
		}
		...
		public Helper.\u02B2\u02B8\u02C1\u02BF\u02B7\u02B4\u02B2\u02B2\u02C0\u02B2\u02BA \u02B3\u02BF\u02B6\u02B4\u02B4\u02BC\u02C0\u02C0\u02B5\u02B2\u02C0()
		{
			return this;
		}

		public Helper.\u02B2\u02B8\u02C1\u02BF\u02B7\u02B4\u02B2\u02B2\u02C0\u02B2\u02BA \u02BC\u02C0\u02B8\u02B9\u02B4\u02BB\u02BE\u02B6\u02BC\u02B7\u02C1()
		{
			return this;
		}
