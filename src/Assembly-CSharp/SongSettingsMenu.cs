...
public class SongSettingsMenu : BaseMenu
{
	...
	public virtual void \u02BF\u02B4\u02BE\u02BC\u02B9\u02BE\u02BD\u02B7\u02C0\u02C1\u02C0()
	{
		...
		if (this.\u02BE\u02BA\u02B2\u02BB\u02BA\u02B3\u02B2\u02B2\u02B6\u02BF\u02B3 == null)
		{
			...
			if (!(text == "setlistSongCountSingular"))
			{
				if (!(text == "All HOPO's"))
				{
					if (text == "album_track")
					{
						this.\u02BC\u02B2\u02B5\u02BF\u02BD\u02B4\u02C1\u02B7\u02B3\u02C1\u02BB = (instance.\u02B8\u02B2\u02B9\u02B4\u02B2\u02B7\u02B4\u02B3\u02B9\u02B6\u02BF.\u02BC\u02B4\u02BA\u02B8\u02B9\u02B4\u02BD\u02BE\u02C0\u02C0\u02BA ? 0 : 1);
					}
				}
				else
				{
					this.\u02BC\u02B2\u02B5\u02BF\u02BD\u02B4\u02C1\u02B7\u02B3\u02C1\u02BB = instance.\u02B8\u02B2\u02B9\u02B4\u02B2\u02B7\u02B4\u02B3\u02B9\u02B6\u02BF.\u02BB\u02B4\u02B2\u02B3\u02B4\u02BD\u02B9\u02B8\u02B5\u02B8\u02BC;
				}
			}
			else
			{
				this.\u02BC\u02B2\u02B5\u02BF\u02BD\u02B4\u02C1\u02B7\u02B3\u02C1\u02BB = instance.\u02B8\u02B2\u02B9\u02B4\u02B2\u02B7\u02B4\u02B3\u02B9\u02B6\u02BF.\u02B4\u02B5\u02BF\u02B2\u02B9\u02B8\u02C1\u02B7\u02BF\u02B3\u02B7;
			}
			this.\u02BA\u02BB\u02B5\u02B6\u02B3\u02BD\u02BA\u02BC\u02B2\u02BB\u02B5();
			return;
		}
		...
		if (!(text == "ScoreDisabledModifier"))
		{
			if (!(text == "SP Colors"))
			{
				if (text == "softMask")
				{
					instance.\u02B8\u02B2\u02B9\u02B4\u02B2\u02B7\u02B4\u02B3\u02B9\u02B6\u02BF.\u02BC\u02B4\u02BA\u02B8\u02B9\u02B4\u02BD\u02BE\u02C0\u02C0\u02BA = this.\u02BC\u02B2\u02B5\u02BF\u02BD\u02B4\u02C1\u02B7\u02B3\u02C1\u02BB == 0 || true;
				}
			}
			else
			{
				instance.\u02B8\u02B2\u02B9\u02B4\u02B2\u02B7\u02B4\u02B3\u02B9\u02B6\u02BF.\u02BB\u02B4\u02B2\u02B3\u02B4\u02BD\u02B9\u02B8\u02B5\u02B8\u02BC = this.\u02BC\u02B2\u02B5\u02BF\u02BD\u02B4\u02C1\u02B7\u02B3\u02C1\u02BB;
			}
		}
		else
		{
			instance.\u02B8\u02B2\u02B9\u02B4\u02B2\u02B7\u02B4\u02B3\u02B9\u02B6\u02BF.\u02B4\u02B5\u02BF\u02B2\u02B9\u02B8\u02C1\u02B7\u02BF\u02B3\u02B7 = this.\u02BC\u02B2\u02B5\u02BF\u02BD\u02B4\u02C1\u02B7\u02B3\u02C1\u02BB;
		}
	...
	public override void \u02B3\u02BC\u02BA\u02C0\u02C0\u02B8\u02B2\u02B4\u02B3\u02C1\u02B8()
	{
		...
		if (this.\u02B9\u02B3\u02B4\u02B7\u02B6\u02BB\u02B4\u02B3\u02BE\u02B5\u02B6)
		{
			try
			{
				GlobalVariables.instance.\u02BA\u02B9\u02BD\u02BA\u02B4\u02B4\u02BF\u02BD\u02B8\u02B3\u02C1.\u02B7\u02B2\u02BF\u02BE\u02B7\u02BF\u02BD\u02BD\u02B7\u02B4\u02B7(true);
	...
	public virtual void \u02C0\u02BE\u02B9\u02B5\u02B6\u02C1\u02B5\u02C0\u02BE\u02B8\u02C1()
	{
		...
		if (this.\u02BE\u02BA\u02B2\u02BB\u02BA\u02B3\u02B2\u02B2\u02B6\u02BF\u02B3 == null)
		{
			...
			if (!(text == "FF0000"))
			{
				if (!(text == "playlist_track"))
				{
					...
					{
						this.\u02BC\u02B2\u02B5\u02BF\u02BD\u02B4\u02C1\u02B7\u02B3\u02C1\u02BB = (instance.\u02B8\u02B2\u02B9\u02B4\u02B2\u02B7\u02B4\u02B3\u02B9\u02B6\u02BF.\u02BC\u02B4\u02BA\u02B8\u02B9\u02B4\u02BD\u02BE\u02C0\u02C0\u02BA ? 1 : 0);
					}
				}
				else
				{
		...
		if (!(text == "fromParts"))
		{
			if (!(text == "A: "))
			{
				if (text == "%points%")
				{
					instance.\u02B8\u02B2\u02B9\u02B4\u02B2\u02B7\u02B4\u02B3\u02B9\u02B6\u02BF.\u02BC\u02B4\u02BA\u02B8\u02B9\u02B4\u02BD\u02BE\u02C0\u02C0\u02BA = this.\u02BC\u02B2\u02B5\u02BF\u02BD\u02B4\u02C1\u02B7\u02B3\u02C1\u02BB == 1 || true;
				}
			}
			else
			{
	...
	public override void ConfirmPressed()
	{
		...
		if (!(text == "Video Start Time"))
		{
			if (!(text == "Song Offset"))
			{
				if (text == "End Events")
				{
					instance.\u02B8\u02B2\u02B9\u02B4\u02B2\u02B7\u02B4\u02B3\u02B9\u02B6\u02BF.\u02BC\u02B4\u02BA\u02B8\u02B9\u02B4\u02BD\u02BE\u02C0\u02C0\u02BA = this.\u02BC\u02B2\u02B5\u02BF\u02BD\u02B4\u02C1\u02B7\u02B3\u02C1\u02BB == 1;
				}
			}
			else
			{
		...
		if (this.\u02BE\u02BA\u02B2\u02BB\u02BA\u02B3\u02B2\u02B2\u02B6\u02BF\u02B3 == null)
		{
			...
			if (!(text == "size too small"))
			{
				if (!(text == "Show Hit Window"))
				{
					if (text == "]")
					{
						this.\u02BC\u02B2\u02B5\u02BF\u02BD\u02B4\u02C1\u02B7\u02B3\u02C1\u02BB = (instance.\u02B8\u02B2\u02B9\u02B4\u02B2\u02B7\u02B4\u02B3\u02B9\u02B6\u02BF.\u02BC\u02B4\u02BA\u02B8\u02B9\u02B4\u02BD\u02BE\u02C0\u02C0\u02BA ? 0 : 0);
					}
				}
				else
				{
