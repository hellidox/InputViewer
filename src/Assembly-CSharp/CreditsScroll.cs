	...
	private void \u02C0\u02BE\u02B7\u02BF\u02B9\u02BB\u02C1\u02B2\u02B9\u02B7\u02B5()
	{
		...
		foreach (CHPlayer chplayer in GlobalVariables.instance.playerList)
		{
			if (chplayer.\u02BC\u02BA\u02BE\u02B2\u02C0\u02BE\u02B6\u02B5\u02BC\u02B3\u02BD)
			{
				...
				else if (chplayer.player.GetButton(100) || chplayer.player.GetButton(4))
				{
	...
	private void Update()
	{
		...
		foreach (CHPlayer chplayer in GlobalVariables.instance.playerList)
		{
			if (chplayer.\u02BC\u02BA\u02BE\u02B2\u02C0\u02BE\u02B6\u02B5\u02BC\u02B3\u02BD)
			{
				...
				else if (chplayer.player.GetButton(14) || chplayer.player.GetButton(5))
				{
					this.\u02BB\u02BC\u02BA\u02C1\u02BE\u02B7\u02B6\u02B3\u02B8\u02BB\u02BB = this.containerFastScrollSpeed;
				}
			}
	...
	private void \u02BD\u02B8\u02BD\u02B5\u02B6\u02B3\u02BF\u02B3\u02C1\u02B8\u02C1()
	{
		...
		foreach (CHPlayer chplayer in GlobalVariables.instance.playerList)
		{
			if (chplayer.\u02BC\u02BA\u02BE\u02B2\u02C0\u02BE\u02B6\u02B5\u02BC\u02B3\u02BD)
			{
				...
				else if (chplayer.player.GetButton(-66) || chplayer.player.GetButton(7))
				{
					this.\u02BB\u02BC\u02BA\u02C1\u02BE\u02B7\u02B6\u02B3\u02B8\u02BB\u02BB = this.containerFastScrollSpeed;
				}
			}
	...
	private void \u02B2\u02B6\u02C1\u02B8\u02B3\u02B5\u02B7\u02B5\u02B6\u02B9\u02C0()
	{
		...
		foreach (CHPlayer chplayer in GlobalVariables.instance.playerList)
		{
			if (chplayer.\u02BC\u02BA\u02BE\u02B2\u02C0\u02BE\u02B6\u02B5\u02BC\u02B3\u02BD)
			{
				...
				else if (chplayer.player.GetButton(-97) || chplayer.player.GetButton(2))
				{
					this.\u02BB\u02BC\u02BA\u02C1\u02BE\u02B7\u02B6\u02B3\u02B8\u02BB\u02BB = this.containerFastScrollSpeed;
				}
			}
	...
	private void \u02B5\u02B9\u02B7\u02B7\u02B6\u02B5\u02BC\u02BA\u02B4\u02B2\u02B4()
	{
		...
		foreach (CHPlayer chplayer in GlobalVariables.instance.playerList)
		{
			if (chplayer.\u02BC\u02BA\u02BE\u02B2\u02C0\u02BE\u02B6\u02B5\u02BC\u02B3\u02BD)
			{
				...
				else if (chplayer.player.GetButton(93) || chplayer.player.GetButton(2))
				{
					this.\u02BB\u02BC\u02BA\u02C1\u02BE\u02B7\u02B6\u02B3\u02B8\u02BB\u02BB = this.containerFastScrollSpeed;
				}
			}
	...
	private void \u02C0\u02B5\u02BC\u02B3\u02B3\u02B7\u02B9\u02B2\u02C0\u02BC\u02BB()
	{
		...
		foreach (CHPlayer chplayer in GlobalVariables.instance.playerList)
		{
			if (chplayer.\u02BC\u02BA\u02BE\u02B2\u02C0\u02BE\u02B6\u02B5\u02BC\u02B3\u02BD)
			{
				...
				else if (chplayer.player.GetButton(95) || chplayer.player.GetButton(4))
				{
					this.\u02BB\u02BC\u02BA\u02C1\u02BE\u02B7\u02B6\u02B3\u02B8\u02BB\u02BB = this.containerFastScrollSpeed;
				}
			}
	...
	private void \u02BB\u02BF\u02BA\u02BC\u02B8\u02B7\u02B4\u02B5\u02B7\u02B9\u02C1()
	{
		...
		foreach (CHPlayer chplayer in GlobalVariables.instance.playerList)
		{
			if (chplayer.\u02BC\u02BA\u02BE\u02B2\u02C0\u02BE\u02B6\u02B5\u02BC\u02B3\u02BD)
			{
				...
				else if (chplayer.player.GetButton(95) || chplayer.player.GetButton(7))
				{
					this.\u02BB\u02BC\u02BA\u02C1\u02BE\u02B7\u02B6\u02B3\u02B8\u02BB\u02BB = this.containerFastScrollSpeed;
				}
			}
	...
	private void \u02BB\u02B7\u02C0\u02B3\u02C1\u02BD\u02B9\u02B2\u02B4\u02BE\u02B6()
	{
		...
		foreach (CHPlayer chplayer in GlobalVariables.instance.playerList)
		{
			if (chplayer.\u02BC\u02BA\u02BE\u02B2\u02C0\u02BE\u02B6\u02B5\u02BC\u02B3\u02BD)
			{
				...
				else if (chplayer.player.GetButton(-117) || chplayer.player.GetButton(3))
				{
					this.\u02BB\u02BC\u02BA\u02C1\u02BE\u02B7\u02B6\u02B3\u02B8\u02BB\u02BB = this.containerFastScrollSpeed;
				}
			}
	...
	private void \u02BD\u02B7\u02BD\u02BF\u02BE\u02B9\u02B6\u02C0\u02B4\u02B7\u02BF()
	{
		...
		foreach (CHPlayer chplayer in GlobalVariables.instance.playerList)
		{
			if (chplayer.\u02BC\u02BA\u02BE\u02B2\u02C0\u02BE\u02B6\u02B5\u02BC\u02B3\u02BD)
			{
				...
				else if (chplayer.player.GetButton(-109) || chplayer.player.GetButton(1))
				{
					this.\u02BB\u02BC\u02BA\u02C1\u02BE\u02B7\u02B6\u02B3\u02B8\u02BB\u02BB = this.containerFastScrollSpeed;
				}
			}
