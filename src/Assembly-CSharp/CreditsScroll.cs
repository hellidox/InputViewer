...
public class CreditsScroll : MonoBehaviour
{
	private void \u02C0\u02BE\u02B7\u02BF\u02B9\u02BB\u02C1\u02B2\u02B9\u02B7\u02B5()
	{
		...
		foreach (CHPlayer chplayer in GlobalVariables.\u02B7\u02B2\u02BA\u02B7\u02BB\u02B3\u02BE\u02B6\u02C1\u02C0\u02B7.\u02B8\u02BD\u02B2\u02B2\u02B7\u02B5\u02B5\u02B3\u02C0\u02BD\u02BF)
		{
			...
			{
				if (chplayer.rewiredPlayer.GetButtonDown(1))
				{
					this.\u02BC\u02B5\u02B5\u02B2\u02B8\u02BF\u02B3\u02BE\u02BB\u02B8\u02B3();
				}
				else if (chplayer.rewiredPlayer.GetButton(100) || chplayer.rewiredPlayer.GetButton(4))
				{
	...
	private void Update()
	{
		...
		foreach (CHPlayer chplayer in GlobalVariables.\u02B7\u02B2\u02BA\u02B7\u02BB\u02B3\u02BE\u02B6\u02C1\u02C0\u02B7.\u02B8\u02BD\u02B2\u02B2\u02B7\u02B5\u02B5\u02B3\u02C0\u02BD\u02BF)
		{
			if (chplayer.\u02BC\u02BA\u02BE\u02B2\u02C0\u02BE\u02B6\u02B5\u02BC\u02B3\u02BD)
			{
				...
				else if (chplayer.rewiredPlayer.GetButton(14) || chplayer.rewiredPlayer.GetButton(5))
				{
					this.\u02BB\u02BC\u02BA\u02C1\u02BE\u02B7\u02B6\u02B3\u02B8\u02BB\u02BB = this.containerFastScrollSpeed;
				}
			}
	...
	private void \u02BD\u02B8\u02BD\u02B5\u02B6\u02B3\u02BF\u02B3\u02C1\u02B8\u02C1()
	{
		...
		foreach (CHPlayer chplayer in GlobalVariables.\u02B7\u02B2\u02BA\u02B7\u02BB\u02B3\u02BE\u02B6\u02C1\u02C0\u02B7.\u02B8\u02BD\u02B2\u02B2\u02B7\u02B5\u02B5\u02B3\u02C0\u02BD\u02BF)
		{
			if (chplayer.\u02BC\u02BA\u02BE\u02B2\u02C0\u02BE\u02B6\u02B5\u02BC\u02B3\u02BD)
			{
				...
				else if (chplayer.rewiredPlayer.GetButton(-66) || chplayer.rewiredPlayer.GetButton(7))
				{
					this.\u02BB\u02BC\u02BA\u02C1\u02BE\u02B7\u02B6\u02B3\u02B8\u02BB\u02BB = this.containerFastScrollSpeed;
				}
			}
	...
	private void \u02B2\u02B6\u02C1\u02B8\u02B3\u02B5\u02B7\u02B5\u02B6\u02B9\u02C0()
	{
		...
		foreach (CHPlayer chplayer in GlobalVariables.\u02B7\u02B2\u02BA\u02B7\u02BB\u02B3\u02BE\u02B6\u02C1\u02C0\u02B7.\u02B8\u02BD\u02B2\u02B2\u02B7\u02B5\u02B5\u02B3\u02C0\u02BD\u02BF)
		{
			if (chplayer.\u02BC\u02BA\u02BE\u02B2\u02C0\u02BE\u02B6\u02B5\u02BC\u02B3\u02BD)
			{
				...
				else if (chplayer.rewiredPlayer.GetButton(-97) || chplayer.rewiredPlayer.GetButton(2))
				{
					this.\u02BB\u02BC\u02BA\u02C1\u02BE\u02B7\u02B6\u02B3\u02B8\u02BB\u02BB = this.containerFastScrollSpeed;
				}
			}
	...
	private void \u02B5\u02B9\u02B7\u02B7\u02B6\u02B5\u02BC\u02BA\u02B4\u02B2\u02B4()
	{
		...
		foreach (CHPlayer chplayer in GlobalVariables.\u02B7\u02B2\u02BA\u02B7\u02BB\u02B3\u02BE\u02B6\u02C1\u02C0\u02B7.\u02B8\u02BD\u02B2\u02B2\u02B7\u02B5\u02B5\u02B3\u02C0\u02BD\u02BF)
		{
			if (chplayer.\u02BC\u02BA\u02BE\u02B2\u02C0\u02BE\u02B6\u02B5\u02BC\u02B3\u02BD)
			{
				...
				else if (chplayer.rewiredPlayer.GetButton(93) || chplayer.rewiredPlayer.GetButton(2))
				{
					this.\u02BB\u02BC\u02BA\u02C1\u02BE\u02B7\u02B6\u02B3\u02B8\u02BB\u02BB = this.containerFastScrollSpeed;
				}
			}
	...
	private void \u02C0\u02B5\u02BC\u02B3\u02B3\u02B7\u02B9\u02B2\u02C0\u02BC\u02BB()
	{
		...
		foreach (CHPlayer chplayer in GlobalVariables.\u02B7\u02B2\u02BA\u02B7\u02BB\u02B3\u02BE\u02B6\u02C1\u02C0\u02B7.\u02B8\u02BD\u02B2\u02B2\u02B7\u02B5\u02B5\u02B3\u02C0\u02BD\u02BF)
		{
			if (chplayer.\u02BC\u02BA\u02BE\u02B2\u02C0\u02BE\u02B6\u02B5\u02BC\u02B3\u02BD)
			{
				...
				else if (chplayer.rewiredPlayer.GetButton(95) || chplayer.rewiredPlayer.GetButton(4))
				{
					this.\u02BB\u02BC\u02BA\u02C1\u02BE\u02B7\u02B6\u02B3\u02B8\u02BB\u02BB = this.containerFastScrollSpeed;
				}
			}
	...
	private void \u02BB\u02BF\u02BA\u02BC\u02B8\u02B7\u02B4\u02B5\u02B7\u02B9\u02C1()
	{
		...
		foreach (CHPlayer chplayer in GlobalVariables.\u02B7\u02B2\u02BA\u02B7\u02BB\u02B3\u02BE\u02B6\u02C1\u02C0\u02B7.\u02B8\u02BD\u02B2\u02B2\u02B7\u02B5\u02B5\u02B3\u02C0\u02BD\u02BF)
		{
			if (chplayer.\u02BC\u02BA\u02BE\u02B2\u02C0\u02BE\u02B6\u02B5\u02BC\u02B3\u02BD)
			{
				...
				else if (chplayer.rewiredPlayer.GetButton(95) || chplayer.rewiredPlayer.GetButton(7))
				{
					this.\u02BB\u02BC\u02BA\u02C1\u02BE\u02B7\u02B6\u02B3\u02B8\u02BB\u02BB = this.containerFastScrollSpeed;
				}
			}
	...
	private void \u02BB\u02B7\u02C0\u02B3\u02C1\u02BD\u02B9\u02B2\u02B4\u02BE\u02B6()
	{
		...
		foreach (CHPlayer chplayer in GlobalVariables.\u02B7\u02B2\u02BA\u02B7\u02BB\u02B3\u02BE\u02B6\u02C1\u02C0\u02B7.\u02B8\u02BD\u02B2\u02B2\u02B7\u02B5\u02B5\u02B3\u02C0\u02BD\u02BF)
		{
			if (chplayer.\u02BC\u02BA\u02BE\u02B2\u02C0\u02BE\u02B6\u02B5\u02BC\u02B3\u02BD)
			{
				...
				else if (chplayer.rewiredPlayer.GetButton(-117) || chplayer.rewiredPlayer.GetButton(3))
				{
					this.\u02BB\u02BC\u02BA\u02C1\u02BE\u02B7\u02B6\u02B3\u02B8\u02BB\u02BB = this.containerFastScrollSpeed;
				}
			}
	...
	private void \u02BD\u02B7\u02BD\u02BF\u02BE\u02B9\u02B6\u02C0\u02B4\u02B7\u02BF()
	{
		...
		foreach (CHPlayer chplayer in GlobalVariables.\u02B7\u02B2\u02BA\u02B7\u02BB\u02B3\u02BE\u02B6\u02C1\u02C0\u02B7.\u02B8\u02BD\u02B2\u02B2\u02B7\u02B5\u02B5\u02B3\u02C0\u02BD\u02BF)
		{
			if (chplayer.\u02BC\u02BA\u02BE\u02B2\u02C0\u02BE\u02B6\u02B5\u02BC\u02B3\u02BD)
			{
				...
				else if (chplayer.rewiredPlayer.GetButton(-109) || chplayer.rewiredPlayer.GetButton(1))
				{
					this.\u02BB\u02BC\u02BA\u02C1\u02BE\u02B7\u02B6\u02B3\u02B8\u02BB\u02BB = this.containerFastScrollSpeed;
				}
			}
