...
{
	// Token: 0x06000B0A RID: 2826 RVA: 0x000617B8 File Offset: 0x0005F9B8
	...
	// Token: 0x06000B0B RID: 2827 RVA: 0x00061834 File Offset: 0x0005FA34
	...
	// Token: 0x06000B0C RID: 2828 RVA: 0x00061984 File Offset: 0x0005FB84
	...
	// Token: 0x06000B0D RID: 2829 RVA: 0x00061A18 File Offset: 0x0005FC18
	...
	// Token: 0x06000B0F RID: 2831 RVA: 0x00061B68 File Offset: 0x0005FD68
	...
	// Token: 0x06000B10 RID: 2832 RVA: 0x00061DDC File Offset: 0x0005FFDC
	...
	// Token: 0x06000B11 RID: 2833 RVA: 0x00061FA8 File Offset: 0x000601A8
	...
	// Token: 0x06000B13 RID: 2835 RVA: 0x000622B0 File Offset: 0x000604B0
	...
	// Token: 0x06000B14 RID: 2836 RVA: 0x0000B86D File Offset: 0x00009A6D
	public virtual void \u02C0\u02BA\u02BA\u02B7\u02B5\u02B4\u02BE\u02B4\u02BD\u02B3\u02B4()
	{
		...
		u02B7_u02B2_u02BA_u02B7_u02BB_u02B3_u02BE_u02B6_u02C1_u02C0_u02B.\u02B6\u02B3\u02B7\u02B5\u02BB\u02BD\u02B3\u02B9\u02BD\u02B2\u02B7 = (Action)Delegate.Combine(u02B7_u02B2_u02BA_u02B7_u02BB_u02B3_u02BE_u02B6_u02C1_u02C0_u02B.\u02B6\u02B3\u02B7\u02B5\u02BB\u02BD\u02B3\u02B9\u02BD\u02B2\u02B7, new Action(this.\u02BE\u02B4\u02B9\u02C1\u02BB\u02C1\u02BC\u02BA\u02B5\u02B8\u02C1));
		this.\u02B5\u02BC\u02BE\u02B3\u02C0\u02B7\u02B5\u02B6\u02BD\u02C1\u02C1();
		this.\u02BD\u02B3\u02B4\u02BB\u02B4\u02C0\u02B7\u02B7\u02B7\u02C0\u02C0();
	}

	// Token: 0x06000B15 RID: 2837 RVA: 0x00062540 File Offset: 0x00060740
	...
	// Token: 0x06000B16 RID: 2838 RVA: 0x000625D4 File Offset: 0x000607D4
	...
	// Token: 0x06000B17 RID: 2839 RVA: 0x00062848 File Offset: 0x00060A48
	...
	// Token: 0x06000B18 RID: 2840 RVA: 0x00062ABC File Offset: 0x00060CBC
	...
	// Token: 0x06000B19 RID: 2841 RVA: 0x0000B8A1 File Offset: 0x00009AA1
	...
	// Token: 0x06000B1A RID: 2842 RVA: 0x0000B8B7 File Offset: 0x00009AB7
	protected virtual void \u02B6\u02BE\u02BF\u02B5\u02B2\u02BD\u02B2\u02B5\u02C0\u02BF\u02B7()
	{
		this.\u02B7\u02BE\u02BA\u02B8\u02BE\u02B2\u02B4\u02C0\u02BE\u02B7\u02BB();
	}

	// Token: 0x06000B1B RID: 2843 RVA: 0x0000B8BF File Offset: 0x00009ABF
	protected override void \u02BA\u02B8\u02B4\u02BA\u02BD\u02BA\u02B7\u02C1\u02B8\u02B8\u02BC()
	{
		this.\u02B2\u02B7\u02B5\u02B5\u02BD\u02BC\u02BF\u02B7\u02C1\u02B7\u02B2();
	}

	// Token: 0x06000B1C RID: 2844 RVA: 0x0000B8B7 File Offset: 0x00009AB7
	private void \u02BE\u02B4\u02B9\u02C1\u02BB\u02C1\u02BC\u02BA\u02B5\u02B8\u02C1()
	{
		this.\u02B7\u02BE\u02BA\u02B8\u02BE\u02B2\u02B4\u02C0\u02BE\u02B7\u02BB();
	}

	// Token: 0x06000B1D RID: 2845 RVA: 0x0000B8A1 File Offset: 0x00009AA1
	...
	// Token: 0x06000B1E RID: 2846 RVA: 0x0000AD77 File Offset: 0x00008F77
	...
	// Token: 0x06000B1F RID: 2847 RVA: 0x0000B8BF File Offset: 0x00009ABF
	private void \u02B2\u02B7\u02B2\u02B3\u02B5\u02B3\u02B8\u02BA\u02B3\u02BC\u02BD()
	{
		this.\u02B2\u02B7\u02B5\u02B5\u02BD\u02BC\u02BF\u02B7\u02C1\u02B7\u02B2();
	}

	// Token: 0x06000B20 RID: 2848 RVA: 0x0000B8C7 File Offset: 0x00009AC7
	private void \u02BD\u02B9\u02C1\u02BF\u02BA\u02B2\u02B8\u02B9\u02BF\u02BB\u02C0()
	{
		this.\u02C1\u02B6\u02B7\u02BC\u02B3\u02BE\u02B3\u02C1\u02B4\u02B2\u02BC.\u02B3\u02BC\u02BA\u02C0\u02C0\u02B8\u02B2\u02B4\u02B3\u02C1\u02B8();
		__FIXME_clon_util.\u02B3\u02BC\u02B9\u02BD\u02BB\u02B6\u02B5\u02B9\u02BC\u02BD\u02BE("song");
	}

	// Token: 0x06000B21 RID: 2849 RVA: 0x0000B8DE File Offset: 0x00009ADE
	private void \u02B3\u02BC\u02B9\u02BD\u02BB\u02B6\u02B5\u02B9\u02BC\u02BD\u02BE()
	{
		this.\u02C1\u02B6\u02B7\u02BC\u02B3\u02BE\u02B3\u02C1\u02B4\u02B2\u02BC.\u02B3\u02BC\u02BA\u02C0\u02C0\u02B8\u02B2\u02B4\u02B3\u02C1\u02B8();
		__FIXME_clon_util.\u02B3\u02BC\u02B9\u02BD\u02BB\u02B6\u02B5\u02B9\u02BC\u02BD\u02BE("");
	}

	// Token: 0x06000B22 RID: 2850 RVA: 0x00062B38 File Offset: 0x00060D38
	public virtual void \u02B3\u02BB\u02B7\u02C0\u02BF\u02B9\u02C1\u02BA\u02B9\u02B8\u02B6(string \u02B4\u02B9\u02B3\u02B9\u02BC\u02C1\u02BE\u02BF\u02B4\u02B9\u02C0 = "")
	{
		...
		foreach (string text in this.\u02C0\u02BA\u02BF\u02B4\u02B7\u02BC\u02B8\u02B4\u02C0\u02C1\u02C1)
		{
			...
			if (num <= 4294967268U)
			{
						...
						if (num == 185U)
						{
							if (text == "Disabled")
							{
								if (Application.platform != (RuntimePlatform)(-75))
								{
									...
									{
										if (gameSetting.CurrentValue == 0)
										{
											this.\u02B7\u02BE\u02BA\u02B4\u02BB\u02B2\u02B6\u02BA\u02C0\u02B3\u02B9[4].text = "[ENHANCED_OPENS]";
										}
										else if (gameSetting.CurrentValue == 1)
										{
											this.\u02B7\u02BE\u02BA\u02B4\u02BB\u02B2\u02B6\u02BA\u02C0\u02B3\u02B9[3].text = "Couldn't load that song";
										}
										else if (gameSetting.CurrentValue == 6)
										{
											this.\u02B7\u02BE\u02BA\u02B4\u02BB\u02B2\u02B6\u02BA\u02C0\u02B3\u02B9[6].text = "offset";
										}
									}
									else if (gameSetting.CurrentValue == 0)
									{
				...
				else if (num <= 4294967179U)
				{
					...
					else if (text == "highway.webm")
					{
						...
						{
							this.\u02B7\u02BE\u02BA\u02B4\u02BB\u02B2\u02B6\u02BA\u02C0\u02B3\u02B9[8].text = gameSetting.GetIntString + "Drums";
						}
					}
				}
					...
					if (num != 14U)
					{
						if (num == 61U)
						{
							if (text == "currentsong.txt")
							{
								...
								switch (gameSetting.CurrentValue)
								{
								case 0:
									text2 = \u02BD\u02B5\u02B7\u02C0\u02BF\u02BA\u02B5\u02B9\u02BD\u02B6\u02C0.\u02C1\u02B9\u02B7\u02BA\u02BB\u02C1\u02B9\u02B8\u02BB\u02B8\u02B6.\u02B5\u02BA\u02BE\u02B9\u02BD\u02B3\u02BB\u02B6\u02B8\u02BD\u02C0("video");
									break;
								case 1:
									text2 = \u02BD\u02B5\u02B7\u02C0\u02BF\u02BA\u02B5\u02B9\u02BD\u02B6\u02C0.\u02B2\u02BE\u02BA\u02B7\u02B4\u02BA\u02BD\u02BE\u02B7\u02B8\u02BE().\u02B3\u02B5\u02BB\u02BE\u02C1\u02B7\u02B2\u02C0\u02C0\u02BB\u02B6("<b>0</b> nps");
									break;
								case 2:
									text2 = \u02BD\u02B5\u02B7\u02C0\u02BF\u02BA\u02B5\u02B9\u02BD\u02B6\u02C0.\u02BA\u02B9\u02C1\u02B9\u02B2\u02BD\u02B2\u02BC\u02B7\u02BA\u02B8().\u02BB\u02B9\u02BB\u02B8\u02B3\u02B2\u02B5\u02B6\u02B4\u02B2\u02B4(": ");
									break;
								case 3:
									text2 = \u02BD\u02B5\u02B7\u02C0\u02BF\u02BA\u02B5\u02B9\u02BD\u02B6\u02C0.\u02BE\u02C0\u02B6\u02B9\u02B7\u02BE\u02B9\u02B6\u02B9\u02BF\u02B2().\u02B5\u02BA\u02BE\u02B9\u02BD\u02B3\u02BB\u02B6\u02B8\u02BD\u02C0("song");
									break;
								case 4:
									text2 = \u02BD\u02B5\u02B7\u02C0\u02BF\u02BA\u02B5\u02B9\u02BD\u02B6\u02C0.\u02BE\u02C0\u02B6\u02B9\u02B7\u02BE\u02B9\u02B6\u02B9\u02BF\u02B2().\u02B3\u02B5\u02BB\u02BE\u02C1\u02B7\u02B2\u02C0\u02C0\u02BB\u02B6("phrase_start");
									break;
								case 5:
									text2 = \u02BD\u02B5\u02B7\u02C0\u02BF\u02BA\u02B5\u02B9\u02BD\u02B6\u02C0.\u02BA\u02B9\u02C1\u02B9\u02B2\u02BD\u02B2\u02BC\u02B7\u02BA\u02B8().\u02B3\u02B5\u02BB\u02BE\u02C1\u02B7\u02B2\u02C0\u02C0\u02BB\u02B6("Gameplay");
									break;
								case 6:
									text2 = \u02BD\u02B5\u02B7\u02C0\u02BF\u02BA\u02B5\u02B9\u02BD\u02B6\u02C0.\u02C1\u02B9\u02B7\u02BA\u02BB\u02C1\u02B9\u02B8\u02BB\u02B8\u02B6.\u02B5\u02BA\u02BE\u02B9\u02BD\u02B3\u02BB\u02B6\u02B8\u02BD\u02C0(", ");
									break;
								case 7:
									text2 = \u02BD\u02B5\u02B7\u02C0\u02BF\u02BA\u02B5\u02B9\u02BD\u02B6\u02C0.\u02BA\u02B9\u02C1\u02B9\u02B2\u02BD\u02B2\u02BC\u02B7\u02BA\u02B8().\u02B5\u02BA\u02BE\u02B9\u02BD\u02B3\u02BB\u02B6\u02B8\u02BD\u02C0("int");
									break;
								case 8:
									text2 = \u02BD\u02B5\u02B7\u02C0\u02BF\u02BA\u02B5\u02B9\u02BD\u02B6\u02C0.\u02C0\u02B4\u02BE\u02B9\u02C1\u02B8\u02B2\u02B3\u02BE\u02BD\u02B9().\u02BB\u02B9\u02BB\u02B8\u02B3\u02B2\u02B5\u02B6\u02B4\u02B2\u02B4("v1shownpopup");
									break;
								case 9:
									text2 = \u02BD\u02B5\u02B7\u02C0\u02BF\u02BA\u02B5\u02B9\u02BD\u02B6\u02C0.\u02BE\u02C0\u02B6\u02B9\u02B7\u02BE\u02B9\u02B6\u02B9\u02BF\u02B2().\u02BB\u02B9\u02BB\u02B8\u02B3\u02B2\u02B5\u02B6\u02B4\u02B2\u02B4("Respawn");
									break;
								case 10:
									text2 = \u02BD\u02B5\u02B7\u02C0\u02BF\u02BA\u02B5\u02B9\u02BD\u02B6\u02C0.\u02B2\u02BE\u02BA\u02B7\u02B4\u02BA\u02BD\u02BE\u02B7\u02B8\u02BE().\u02B3\u02B5\u02BB\u02BE\u02C1\u02B7\u02B2\u02C0\u02C0\u02BB\u02B6("beat");
									break;
								case 11:
									text2 = \u02BD\u02B5\u02B7\u02C0\u02BF\u02BA\u02B5\u02B9\u02BD\u02B6\u02C0.\u02C1\u02B9\u02B7\u02BA\u02BB\u02C1\u02B9\u02B8\u02BB\u02B8\u02B6.\u02B5\u02BA\u02BE\u02B9\u02BD\u02B3\u02BB\u02B6\u02B8\u02BD\u02C0("Yes");
									break;
								case 12:
									text2 = \u02BD\u02B5\u02B7\u02C0\u02BF\u02BA\u02B5\u02B9\u02BD\u02B6\u02C0.\u02BE\u02C0\u02B6\u02B9\u02B7\u02BE\u02B9\u02B6\u02B9\u02BF\u02B2().\u02BB\u02B9\u02BB\u02B8\u02B3\u02B2\u02B5\u02B6\u02B4\u02B2\u02B4("CSSetWhammyColumn");
									break;
								case 13:
									text2 = \u02BD\u02B5\u02B7\u02C0\u02BF\u02BA\u02B5\u02B9\u02BD\u02B6\u02C0.\u02BE\u02C0\u02B6\u02B9\u02B7\u02BE\u02B9\u02B6\u02B9\u02BF\u02B2().\u02BB\u02B9\u02BB\u02B8\u02B3\u02B2\u02B5\u02B6\u02B4\u02B2\u02B4("DiscordRPC: is now offline due to error");
									break;
								case 14:
									text2 = \u02BD\u02B5\u02B7\u02C0\u02BF\u02BA\u02B5\u02B9\u02BD\u02B6\u02C0.\u02C0\u02B4\u02BE\u02B9\u02C1\u02B8\u02B2\u02B3\u02BE\u02BD\u02B9().\u02B5\u02BA\u02BE\u02B9\u02BD\u02B3\u02BB\u02B6\u02B8\u02BD\u02C0("Rhythm Guitar");
									break;
								}
			...
			else if (text == "Press <color=\"green\">Green</color> to continue.")
			{
				...
				if (gameSetting.CurrentValue > 116)
				{
	...
	// Token: 0x06000B23 RID: 2851 RVA: 0x000632BC File Offset: 0x000614BC
	...
	// Token: 0x06000B24 RID: 2852 RVA: 0x0000B8F5 File Offset: 0x00009AF5
	public override void \u02B4\u02BF\u02B6\u02B3\u02B7\u02BA\u02B9\u02B9\u02BD\u02BD\u02B4()
	{
		GlobalVariables u02B7_u02B2_u02BA_u02B7_u02BB_u02B3_u02BE_u02B6_u02C1_u02C0_u02B = GlobalVariables.\u02B7\u02B2\u02BA\u02B7\u02BB\u02B3\u02BE\u02B6\u02C1\u02C0\u02B7;
		u02B7_u02B2_u02BA_u02B7_u02BB_u02B3_u02BE_u02B6_u02C1_u02C0_u02B.\u02B6\u02B3\u02B7\u02B5\u02BB\u02BD\u02B3\u02B9\u02BD\u02B2\u02B7 = (Action)Delegate.Combine(u02B7_u02B2_u02BA_u02B7_u02BB_u02B3_u02BE_u02B6_u02C1_u02C0_u02B.\u02B6\u02B3\u02B7\u02B5\u02BB\u02BD\u02B3\u02B9\u02BD\u02B2\u02B7, new Action(this.\u02B2\u02B7\u02B2\u02B3\u02B5\u02B3\u02B8\u02BA\u02B3\u02BC\u02BD));
		this.\u02B5\u02BC\u02BE\u02B3\u02C0\u02B7\u02B5\u02B6\u02BD\u02C1\u02C1();
		this.\u02BD\u02B3\u02B4\u02BB\u02B4\u02C0\u02B7\u02B7\u02B7\u02C0\u02C0();
	}

	// Token: 0x06000B25 RID: 2853 RVA: 0x0006333C File Offset: 0x0006153C
	...
	// Token: 0x06000B26 RID: 2854 RVA: 0x00063508 File Offset: 0x00061708
	public virtual void \u02C1\u02B2\u02BC\u02B9\u02B4\u02B6\u02B6\u02B5\u02B3\u02BB\u02B2(string \u02B4\u02B9\u02B3\u02B9\u02BC\u02C1\u02BE\u02BF\u02B4\u02B9\u02C0 = "")
	{
		...
		foreach (string text in this.\u02C0\u02BA\u02BF\u02B4\u02B7\u02BC\u02B8\u02B4\u02C0\u02C1\u02C1)
		{
			...
			if (num <= 112U)
			{
				...
				else if (num <= 4294967282U)
				{
					...
					else if (text == "song")
					{
						...
						{
							this.\u02B7\u02BE\u02BA\u02B4\u02BB\u02B2\u02B6\u02BA\u02C0\u02B3\u02B9[6].text = gameSetting.GetIntString + "Yes";
						}
					}
				}
				else if (num != 4294967219U)
					...
					if (num != 87U)
					{
						if (num == 4294967118U)
						{
							if (text == "Guest")
							{
								...
								{
								case 0:
									text2 = \u02BD\u02B5\u02B7\u02C0\u02BF\u02BA\u02B5\u02B9\u02BD\u02B6\u02C0.\u02BE\u02C0\u02B6\u02B9\u02B7\u02BE\u02B9\u02B6\u02B9\u02BF\u02B2().\u02BB\u02B9\u02BB\u02B8\u02B3\u02B2\u02B5\u02B6\u02B4\u02B2\u02B4("highway_shake");
									break;
								case 1:
									text2 = \u02BD\u02B5\u02B7\u02C0\u02BF\u02BA\u02B5\u02B9\u02BD\u02B6\u02C0.\u02BE\u02C0\u02B6\u02B9\u02B7\u02BE\u02B9\u02B6\u02B9\u02BF\u02B2().\u02BB\u02B9\u02BB\u02B8\u02B3\u02B2\u02B5\u02B6\u02B4\u02B2\u02B4("notes");
									break;
								case 2:
									text2 = \u02BD\u02B5\u02B7\u02C0\u02BF\u02BA\u02B5\u02B9\u02BD\u02B6\u02C0.\u02C1\u02B9\u02B7\u02BA\u02BB\u02C1\u02B9\u02B8\u02BB\u02B8\u02B6.\u02B3\u02B5\u02BB\u02BE\u02C1\u02B7\u02B2\u02C0\u02C0\u02BB\u02B6("Device in use by ");
									break;
								case 3:
									text2 = \u02BD\u02B5\u02B7\u02C0\u02BF\u02BA\u02B5\u02B9\u02BD\u02B6\u02C0.\u02BA\u02B9\u02C1\u02B9\u02B2\u02BD\u02B2\u02BC\u02B7\u02BA\u02B8().\u02B9\u02BC\u02BD\u02BE\u02BA\u02C0\u02BC\u02C1\u02BD\u02B3\u02BD("{0:N0}");
									break;
								case 4:
									text2 = \u02BD\u02B5\u02B7\u02C0\u02BF\u02BA\u02B5\u02B9\u02BD\u02B6\u02C0.\u02BA\u02B9\u02C1\u02B9\u02B2\u02BD\u02B2\u02BC\u02B7\u02BA\u02B8().\u02B9\u02BC\u02BD\u02BE\u02BA\u02C0\u02BC\u02C1\u02BD\u02B3\u02BD("Double Strum Prevention");
									break;
								case 5:
									text2 = \u02BD\u02B5\u02B7\u02C0\u02BF\u02BA\u02B5\u02B9\u02BD\u02B6\u02C0.\u02C0\u02B4\u02BE\u02B9\u02C1\u02B8\u02B2\u02B3\u02BE\u02BD\u02B9().\u02BB\u02B9\u02BB\u02B8\u02B3\u02B2\u02B5\u02B6\u02B4\u02B2\u02B4("{0:n0}");
									break;
								case 6:
									text2 = \u02BD\u02B5\u02B7\u02C0\u02BF\u02BA\u02B5\u02B9\u02BD\u02B6\u02C0.\u02C1\u02B9\u02B7\u02BA\u02BB\u02C1\u02B9\u02B8\u02BB\u02B8\u02B6.\u02B3\u02B5\u02BB\u02BE\u02C1\u02B7\u02B2\u02C0\u02C0\u02BB\u02B6("analytics-opt-out");
									break;
								case 7:
									text2 = \u02BD\u02B5\u02B7\u02C0\u02BF\u02BA\u02B5\u02B9\u02BD\u02B6\u02C0.\u02C0\u02B4\u02BE\u02B9\u02C1\u02B8\u02B2\u02B3\u02BE\u02BD\u02B9().\u02B3\u02B5\u02BB\u02BE\u02C1\u02B7\u02B2\u02C0\u02C0\u02BB\u02B6("");
									break;
								case 8:
									text2 = \u02BD\u02B5\u02B7\u02C0\u02BF\u02BA\u02B5\u02B9\u02BD\u02B6\u02C0.\u02C0\u02B4\u02BE\u02B9\u02C1\u02B8\u02B2\u02B3\u02BE\u02BD\u02B9().\u02B3\u02B5\u02BB\u02BE\u02C1\u02B7\u02B2\u02C0\u02C0\u02BB\u02B6("song");
									break;
								case 9:
									text2 = \u02BD\u02B5\u02B7\u02C0\u02BF\u02BA\u02B5\u02B9\u02BD\u02B6\u02C0.\u02BE\u02C0\u02B6\u02B9\u02B7\u02BE\u02B9\u02B6\u02B9\u02BF\u02B2().\u02B5\u02BA\u02BE\u02B9\u02BD\u02B3\u02BB\u02B6\u02B8\u02BD\u02C0("Kick / Open Notes");
									break;
								case 10:
									text2 = \u02BD\u02B5\u02B7\u02C0\u02BF\u02BA\u02B5\u02B9\u02BD\u02B6\u02C0.\u02C1\u02B9\u02B7\u02BA\u02BB\u02C1\u02B9\u02B8\u02BB\u02B8\u02B6.\u02B5\u02BA\u02BE\u02B9\u02BD\u02B3\u02BB\u02B6\u02B8\u02BD\u02C0("whammy_sfx");
									break;
								case 11:
									text2 = \u02BD\u02B5\u02B7\u02C0\u02BF\u02BA\u02B5\u02B9\u02BD\u02B6\u02C0.\u02C0\u02B4\u02BE\u02B9\u02C1\u02B8\u02B2\u02B3\u02BE\u02BD\u02B9().\u02B9\u02BC\u02BD\u02BE\u02BA\u02C0\u02BC\u02C1\u02BD\u02B3\u02BD("guitar6fret");
									break;
								case 12:
									text2 = \u02BD\u02B5\u02B7\u02C0\u02BF\u02BA\u02B5\u02B9\u02BD\u02B6\u02C0.\u02BA\u02B9\u02C1\u02B9\u02B2\u02BD\u02B2\u02BC\u02B7\u02BA\u02B8().\u02B5\u02BA\u02BE\u02B9\u02BD\u02B3\u02BB\u02B6\u02B8\u02BD\u02C0("song");
									break;
								case 13:
									text2 = \u02BD\u02B5\u02B7\u02C0\u02BF\u02BA\u02B5\u02B9\u02BD\u02B6\u02C0.\u02BE\u02C0\u02B6\u02B9\u02B7\u02BE\u02B9\u02B6\u02B9\u02BF\u02B2().\u02B9\u02BC\u02BD\u02BE\u02BA\u02C0\u02BC\u02C1\u02BD\u02B3\u02BD("");
									break;
								case 14:
									text2 = \u02BD\u02B5\u02B7\u02C0\u02BF\u02BA\u02B5\u02B9\u02BD\u02B6\u02C0.\u02C1\u02B9\u02B7\u02BA\u02BB\u02C1\u02B9\u02B8\u02BB\u02B8\u02B6.\u02B5\u02BA\u02BE\u02B9\u02BD\u02B3\u02BB\u02B6\u02B8\u02BD\u02C0("Song");
									break;
								}
			...
			{
				base.\u02BA\u02BC\u02C1\u02BE\u02B4\u02B3\u02BA\u02BC\u02BB\u02C1\u02BB(1, gameSetting);
				if (gameSetting.CurrentValue > 164)
				{
	...
	// Token: 0x06000B27 RID: 2855 RVA: 0x00063C8C File Offset: 0x00061E8C
	private void \u02B5\u02BC\u02BE\u02B3\u02C0\u02B7\u02B5\u02B6\u02BD\u02C1\u02C1()
	{
		this.\u02BF\u02B3\u02BC\u02BB\u02C0\u02B4\u02BC\u02C0\u02C1\u02B2\u02BE = new List<VideoSettingsMenu.\u02B8\u02BA\u02B2\u02B4\u02B5\u02C1\u02B2\u02BD\u02BB\u02B9\u02BF>();
		__FIXME_clon_util.\u02C0\u02BF\u02B7\u02BA\u02B6\u02BA\u02B2\u02B4\u02B5\u02B8\u02B9 u02C0_u02BF_u02B7_u02BA_u02B6_u02BA_u02B2_u02B4_u02B5_u02B8_u02B = __FIXME_clon_util.\u02C1\u02BF\u02B8\u02B2\u02BA\u02B3\u02B4\u02B3\u02C1\u02BC\u02BE((uint)__FIXME_clon_util.SupportedGraphicsAPIs()).\u02BC\u02C0\u02B8\u02B9\u02B4\u02BB\u02BE\u02B6\u02BC\u02B7\u02C1();
		while (u02C0_u02BF_u02B7_u02BA_u02B6_u02BA_u02B2_u02B4_u02B5_u02B8_u02B.\u02BF\u02B5\u02B7\u02BB\u02B5\u02BB\u02B7\u02B5\u02B6\u02BA\u02BC())
		{
			__FIXME_clon_util.GraphicsAPI graphicsAPI = (__FIXME_clon_util.GraphicsAPI)u02C0_u02BF_u02B7_u02BA_u02B6_u02BA_u02B2_u02B4_u02B5_u02B8_u02B.\u02B9\u02BA\u02BB\u02B4\u02C0\u02B4\u02B6\u02B2\u02B9\u02B3\u02BF;
			...
			u02B8_u02BA_u02B2_u02B4_u02B5_u02C1_u02B2_u02BD_u02BB_u02B9_u02BF.\u02BF\u02B4\u02C1\u02BC\u02BC\u02B2\u02BC\u02BB\u02BA\u02B2\u02B6 = __FIXME_clon_util.\u02B9\u02B6\u02C0\u02B9\u02B3\u02BA\u02B8\u02BF\u02B4\u02BE\u02BB(graphicsAPI);
	...
	// Token: 0x06000B28 RID: 2856 RVA: 0x00063CF4 File Offset: 0x00061EF4
	...
	// Token: 0x06000B29 RID: 2857 RVA: 0x00063D70 File Offset: 0x00061F70
	...
	// Token: 0x06000B2A RID: 2858 RVA: 0x0006410C File Offset: 0x0006230C
	...
	// Token: 0x06000B2B RID: 2859 RVA: 0x0000B8A1 File Offset: 0x00009AA1
	...
	// Token: 0x06000B2C RID: 2860 RVA: 0x0000B929 File Offset: 0x00009B29
	private void \u02B7\u02C1\u02BF\u02B2\u02B5\u02BE\u02BB\u02B6\u02C0\u02BC\u02C0()
	{
		this.\u02C1\u02B6\u02B7\u02BC\u02B3\u02BE\u02B3\u02C1\u02B4\u02B2\u02BC.\u02B3\u02BC\u02BA\u02C0\u02C0\u02B8\u02B2\u02B4\u02B3\u02C1\u02B8();
		__FIXME_clon_util.\u02B3\u02BC\u02B9\u02BD\u02BB\u02B6\u02B5\u02B9\u02BC\u02BD\u02BE("Type the setlist name");
	}

	// Token: 0x06000B2D RID: 2861 RVA: 0x0006418C File Offset: 0x0006238C
	public override void \u02BA\u02B4\u02BC\u02BA\u02B7\u02B7\u02B7\u02BE\u02B7\u02C1\u02C0(string \u02B4\u02B9\u02B3\u02B9\u02BC\u02C1\u02BE\u02BF\u02B4\u02B9\u02C0 = "")
	{
		...
		foreach (string text in this.\u02C0\u02BA\u02BF\u02B4\u02B7\u02BC\u02B8\u02B4\u02C0\u02C1\u02C1)
		{
			...
			if (num <= 1595303295U)
			{
							...
							if (text == "Fullscreen")
							{
								if (Application.platform != RuntimePlatform.Android)
								{
									if (Application.platform == RuntimePlatform.WindowsEditor || Application.platform == RuntimePlatform.WindowsPlayer)
									{
										...
										else if (gameSetting.CurrentValue == 2)
										{
				...
				else if (num <= 1510332853U)
				{
					...
					else if (text == "MSAA Level")
					{
						...
						{
							this.\u02B7\u02BE\u02BA\u02B4\u02BB\u02B2\u02B6\u02BA\u02C0\u02B3\u02B9[3].text = gameSetting.GetIntString + "x";
						}
					}
				}
				else if (num != 1539377232U)
					...
					if (num != 1972880082U)
					{
						if (num == 2086318127U)
						{
							if (text == "Menu Backgrounds")
							{
								...
								{
								case 0:
									text2 = \u02BD\u02B5\u02B7\u02C0\u02BF\u02BA\u02B5\u02B9\u02BD\u02B6\u02C0.\u02C1\u02B9\u02B7\u02BA\u02BB\u02C1\u02B9\u02B8\u02BB\u02B8\u02B6.\u02B3\u02B5\u02BB\u02BE\u02C1\u02B7\u02B2\u02C0\u02C0\u02BB\u02B6("Animated");
									break;
								case 1:
									text2 = \u02BD\u02B5\u02B7\u02C0\u02BF\u02BA\u02B5\u02B9\u02BD\u02B6\u02C0.\u02C1\u02B9\u02B7\u02BA\u02BB\u02C1\u02B9\u02B8\u02BB\u02B8\u02B6.\u02B3\u02B5\u02BB\u02BE\u02C1\u02B7\u02B2\u02C0\u02C0\u02BB\u02B6("Static");
									break;
								case 2:
									text2 = \u02BD\u02B5\u02B7\u02C0\u02BF\u02BA\u02B5\u02B9\u02BD\u02B6\u02C0.\u02C1\u02B9\u02B7\u02BA\u02BB\u02C1\u02B9\u02B8\u02BB\u02B8\u02B6.\u02B3\u02B5\u02BB\u02BE\u02C1\u02B7\u02B2\u02C0\u02C0\u02BB\u02B6("Surfer");
									break;
								case 3:
									text2 = \u02BD\u02B5\u02B7\u02C0\u02BF\u02BA\u02B5\u02B9\u02BD\u02B6\u02C0.\u02C1\u02B9\u02B7\u02BA\u02BB\u02C1\u02B9\u02B8\u02BB\u02B8\u02B6.\u02B3\u02B5\u02BB\u02BE\u02C1\u02B7\u02B2\u02C0\u02C0\u02BB\u02B6("Classic");
									break;
								case 4:
									text2 = \u02BD\u02B5\u02B7\u02C0\u02BF\u02BA\u02B5\u02B9\u02BD\u02B6\u02C0.\u02C1\u02B9\u02B7\u02BA\u02BB\u02C1\u02B9\u02B8\u02BB\u02B8\u02B6.\u02B3\u02B5\u02BB\u02BE\u02C1\u02B7\u02B2\u02C0\u02C0\u02BB\u02B6("Dark");
									break;
								case 5:
									text2 = \u02BD\u02B5\u02B7\u02C0\u02BF\u02BA\u02B5\u02B9\u02BD\u02B6\u02C0.\u02C1\u02B9\u02B7\u02BA\u02BB\u02C1\u02B9\u02B8\u02BB\u02B8\u02B6.\u02B3\u02B5\u02BB\u02BE\u02C1\u02B7\u02B2\u02C0\u02C0\u02BB\u02B6("Light");
									break;
								case 6:
									text2 = \u02BD\u02B5\u02B7\u02C0\u02BF\u02BA\u02B5\u02B9\u02BD\u02B6\u02C0.\u02C1\u02B9\u02B7\u02BA\u02BB\u02C1\u02B9\u02B8\u02BB\u02B8\u02B6.\u02B3\u02B5\u02BB\u02BE\u02C1\u02B7\u02B2\u02C0\u02C0\u02BB\u02B6("Autumn");
									break;
								case 7:
									text2 = \u02BD\u02B5\u02B7\u02C0\u02BF\u02BA\u02B5\u02B9\u02BD\u02B6\u02C0.\u02C1\u02B9\u02B7\u02BA\u02BB\u02C1\u02B9\u02B8\u02BB\u02B8\u02B6.\u02B3\u02B5\u02BB\u02BE\u02C1\u02B7\u02B2\u02C0\u02C0\u02BB\u02B6("Alien");
									break;
								case 8:
									text2 = \u02BD\u02B5\u02B7\u02C0\u02BF\u02BA\u02B5\u02B9\u02BD\u02B6\u02C0.\u02C1\u02B9\u02B7\u02BA\u02BB\u02C1\u02B9\u02B8\u02BB\u02B8\u02B6.\u02B3\u02B5\u02BB\u02BE\u02C1\u02B7\u02B2\u02C0\u02C0\u02BB\u02B6("Blue Rays");
									break;
								case 9:
									text2 = \u02BD\u02B5\u02B7\u02C0\u02BF\u02BA\u02B5\u02B9\u02BD\u02B6\u02C0.\u02C1\u02B9\u02B7\u02BA\u02BB\u02C1\u02B9\u02B8\u02BB\u02B8\u02B6.\u02B3\u02B5\u02BB\u02BE\u02C1\u02B7\u02B2\u02C0\u02C0\u02BB\u02B6("Grains");
									break;
								case 10:
									text2 = \u02BD\u02B5\u02B7\u02C0\u02BF\u02BA\u02B5\u02B9\u02BD\u02B6\u02C0.\u02C1\u02B9\u02B7\u02BA\u02BB\u02C1\u02B9\u02B8\u02BB\u02B8\u02B6.\u02B3\u02B5\u02BB\u02BE\u02C1\u02B7\u02B2\u02C0\u02C0\u02BB\u02B6("Groovy");
									break;
								case 11:
									text2 = \u02BD\u02B5\u02B7\u02C0\u02BF\u02BA\u02B5\u02B9\u02BD\u02B6\u02C0.\u02C1\u02B9\u02B7\u02BA\u02BB\u02C1\u02B9\u02B8\u02BB\u02B8\u02B6.\u02B3\u02B5\u02BB\u02BE\u02C1\u02B7\u02B2\u02C0\u02C0\u02BB\u02B6("Pastel Burst");
									break;
								case 12:
									text2 = \u02BD\u02B5\u02B7\u02C0\u02BF\u02BA\u02B5\u02B9\u02BD\u02B6\u02C0.\u02C1\u02B9\u02B7\u02BA\u02BB\u02C1\u02B9\u02B8\u02BB\u02B8\u02B6.\u02B3\u02B5\u02BB\u02BE\u02C1\u02B7\u02B2\u02C0\u02C0\u02BB\u02B6("Rainbow");
									break;
								case 13:
									text2 = \u02BD\u02B5\u02B7\u02C0\u02BF\u02BA\u02B5\u02B9\u02BD\u02B6\u02C0.\u02C1\u02B9\u02B7\u02BA\u02BB\u02C1\u02B9\u02B8\u02BB\u02B8\u02B6.\u02B3\u02B5\u02BB\u02BE\u02C1\u02B7\u02B2\u02C0\u02C0\u02BB\u02B6("Spray");
									break;
								case 14:
									text2 = \u02BD\u02B5\u02B7\u02C0\u02BF\u02BA\u02B5\u02B9\u02BD\u02B6\u02C0.\u02C1\u02B9\u02B7\u02BA\u02BB\u02C1\u02B9\u02B8\u02BB\u02B8\u02B6.\u02B3\u02B5\u02BB\u02BE\u02C1\u02B7\u02B2\u02C0\u02C0\u02BB\u02B6("Black");
									break;
								}
			...
			else if (text == "Framerate")
			{
				...
				if (gameSetting.CurrentValue > 2000)
				{
	...
	private struct \u02B8\u02BA\u02B2\u02B4\u02B5\u02C1\u02B2\u02BD\u02BB\u02B9\u02BF
	{
		...
		public __FIXME_clon_util.GraphicsAPI \u02BB\u02B5\u02BA\u02B6\u02BE\u02BA\u02B6\u02BD\u02B3\u02B9\u02BF;
	}
}
