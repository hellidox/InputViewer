...
public class GameplaySettingsMenu : BaseSettingMenu
{
			...
			else if (num <= 3587543207U)
			{
				if (num != 3558350423U)
				{
					if (num == 3587543207U)
					{
						...
						{
							GlobalVariables.instance.\u02BC\u02BE\u02B5\u02BC\u02B6\u02B5\u02BA\u02BD\u02B6\u02B5\u02B8(true);
							this.\u02BA\u02B8\u02B4\u02BA\u02BD\u02BA\u02B7\u02C1\u02B8\u02B8\u02BC();
							this.\u02BE\u02BA\u02B2\u02BB\u02BA\u02B3\u02B2\u02B2\u02B6\u02BF\u02B3 = null;
		...
		foreach (string text in this.\u02C0\u02BA\u02BF\u02B4\u02B7\u02BC\u02B8\u02B4\u02C0\u02C1\u02C1)
		{
						...
						if (num != 4294967193U)
						{
							if (num == 93U)
							{
								if (text == "bassinitfail")
								{
									...
									this.\u02B7\u02BE\u02BA\u02B4\u02BB\u02B2\u02B6\u02BA\u02C0\u02B3\u02B9[4].text = this.\u02B7\u02B9\u02B6\u02B6\u02B8\u02B4\u02B7\u02C1\u02B2\u02BA\u02BC(settingFromString.CurrentValue, "Bass", GlobalVariables.instance.\u02B7\u02B9\u02BD\u02BC\u02B7\u02B6\u02B2\u02B2\u02BC\u02BB\u02BB);
								}
							}
						}
			...
			else if (num <= 4U)
			{
				...
				else if (text == "8EDC4F")
				{
					...
					this.\u02B7\u02BE\u02BA\u02B4\u02BB\u02B2\u02B6\u02BA\u02C0\u02B3\u02B9[1].text = this.\u02BF\u02B7\u02BE\u02BD\u02BC\u02BB\u02C0\u02BA\u02C0\u02BD\u02BF(settingFromString.CurrentValue, "midi_export", GlobalVariables.instance.\u02B9\u02BB\u02B2\u02B8\u02B3\u02B7\u02B3\u02B2\u02BD\u02B9\u02BF);
				}
			}
			else if (num <= 12U)
			{
	...
	{
		this.\u02C0\u02BB\u02B6\u02B2\u02B5\u02BD\u02BC\u02B6\u02B9\u02B2\u02B9 = GlobalVariables.instance.\u02B9\u02BB\u02B2\u02B8\u02B3\u02B7\u02B3\u02B2\u02BD\u02B9\u02BF != null && GlobalVariables.instance.\u02B9\u02BB\u02B2\u02B8\u02B3\u02B7\u02B3\u02B2\u02BD\u02B9\u02BF.Length != 0;
		this.\u02C0\u02BA\u02B9\u02B7\u02B8\u02B6\u02B2\u02C1\u02BF\u02BD\u02B2 = GlobalVariables.instance.\u02B7\u02B9\u02BD\u02BC\u02B7\u02B6\u02B2\u02B2\u02BC\u02BB\u02BB != null && GlobalVariables.instance.\u02B7\u02B9\u02BD\u02BC\u02B7\u02B6\u02B2\u02B2\u02BC\u02BB\u02BB.Length != 0;
		SettingsController.background_image.MaxValue = (this.\u02C0\u02BB\u02B6\u02B2\u02B5\u02BD\u02BC\u02B6\u02B9\u02B2\u02B9 ? (GlobalVariables.instance.\u02B9\u02BB\u02B2\u02B8\u02B3\u02B7\u02B3\u02B2\u02BD\u02B9\u02BF.Length - 1) : (-2));
		SettingsController.background_video.MaxValue = (this.\u02C0\u02BA\u02B9\u02B7\u02B8\u02B6\u02B2\u02C1\u02BF\u02BD\u02B2 ? (GlobalVariables.instance.\u02B7\u02B9\u02BD\u02BC\u02B7\u02B6\u02B2\u02B2\u02BC\u02BB\u02BB.Length - 1) : (-2));
	}
		...
		foreach (string text in this.\u02C0\u02BA\u02BF\u02B4\u02B7\u02BC\u02B8\u02B4\u02C0\u02C1\u02C1)
		{
						...
						if (num != 972458324U)
						{
							if (num == 1224852698U)
							{
								if (text == "Background Video")
								{
									...
									this.\u02B7\u02BE\u02BA\u02B4\u02BB\u02B2\u02B6\u02BA\u02C0\u02B3\u02B9[2].text = this.\u02BF\u02B7\u02BE\u02BD\u02BC\u02BB\u02C0\u02BA\u02C0\u02BD\u02BF(settingFromString.CurrentValue, "No Videos!", GlobalVariables.instance.\u02B7\u02B9\u02BD\u02BC\u02B7\u02B6\u02B2\u02B2\u02BC\u02BB\u02BB);
								}
							}
						}
			...
			else if (num <= 3148303310U)
			{
				...
				else if (text == "Background Image")
				{
					...
					this.\u02B7\u02BE\u02BA\u02B4\u02BB\u02B2\u02B6\u02BA\u02C0\u02B3\u02B9[1].text = this.\u02BF\u02B7\u02BE\u02BD\u02BC\u02BB\u02C0\u02BA\u02C0\u02BD\u02BF(settingFromString.CurrentValue, "No Images!", GlobalVariables.instance.\u02B9\u02BB\u02B2\u02B8\u02B3\u02B7\u02B3\u02B2\u02BD\u02B9\u02BF);
				}
			}
			else if (num <= 3502736215U)
			{
