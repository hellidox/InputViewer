...
public class SongSelectSearch : MonoBehaviour
{
	private void \u02C0\u02B3\u02B2\u02B6\u02B3\u02B8\u02B8\u02C1\u02BE\u02B9\u02B3()
	{
		...
		string text = LanguageManager.instance.\u02B5\u02BA\u02BE\u02B9\u02BD\u02B3\u02BB\u02B6\u02B8\u02BD\u02C0(SongSelectSearch.\u02BF\u02BE\u02B6\u02BB\u02BF\u02B5\u02B4\u02BD\u02BD\u02BF\u02B5[SongSelectSearch.\u02B7\u02B6\u02B8\u02B7\u02B5\u02BE\u02C0\u02C1\u02B8\u02BE\u02B4]) + "Setlist" + u02BF_u02BC_u02B9_u02C1_u02B8_u02C1_u02BF_u02BB_u02BF_u02B7_u02BB.text;
	...
	private void Update()
	{
		...
		{
			if (chplayer != null && chplayer.player != null && !chplayer.\u02BD\u02BC\u02B8\u02B5\u02B5\u02B2\u02C0\u02C1\u02B3\u02C0\u02B4 && (chplayer.player.GetButtonDown(0) || chplayer.player.GetButtonDown(1)))
			{
				base.StartCoroutine(this.\u02B3\u02BD\u02B5\u02B6\u02BC\u02B9\u02B2\u02C1\u02B5\u02BC\u02B7());
	...
	private void \u02BD\u02B8\u02BD\u02B5\u02B6\u02B3\u02BF\u02B3\u02C1\u02B8\u02C1()
	{
		...
		foreach (CHPlayer chplayer in GlobalVariables.instance.playerList)
		{
			if (chplayer != null && chplayer.player != null && !chplayer.\u02B8\u02C0\u02BB\u02C0\u02BB\u02BB\u02BE\u02B3\u02BD\u02B2\u02B6() && (chplayer.player.GetButtonDown(1) || chplayer.player.GetButtonDown(0)))
			{
	...
	private void \u02C1\u02BE\u02BF\u02C0\u02BC\u02B7\u02BC\u02BC\u02BE\u02B5\u02BC()
	{
		...
		utf16ValueStringBuilder.Append(LanguageManager.\u02BE\u02C0\u02B6\u02B9\u02B7\u02BE\u02B9\u02B6\u02B9\u02BF\u02B2().\u02BB\u02B9\u02BB\u02B8\u02B3\u02B2\u02B5\u02B6\u02B4\u02B2\u02B4("Gameplay"));
		utf16ValueStringBuilder.Append(": ");
		utf16ValueStringBuilder.Append(LanguageManager.\u02BA\u02B9\u02C1\u02B9\u02B2\u02BD\u02B2\u02BC\u02B7\u02BA\u02B8().\u02B9\u02BC\u02BD\u02BE\u02BA\u02C0\u02BC\u02C1\u02BD\u02B3\u02BD(SongSelectSearch.\u02BF\u02BE\u02B6\u02BB\u02BF\u02B5\u02B4\u02BD\u02BD\u02BF\u02B5[SongSelectSearch.\u02B7\u02B6\u02B8\u02B7\u02B5\u02BE\u02C0\u02C1\u02B8\u02BE\u02B4]));
	...
	private void \u02B9\u02B7\u02C0\u02B7\u02C1\u02BA\u02BC\u02C0\u02C1\u02BD\u02B6()
	{
		...
		if (SettingsController.default_search_by_current_sort)
		{
	...
	private void \u02B3\u02B8\u02C0\u02B6\u02B3\u02C0\u02B2\u02C1\u02BD\u02BA\u02BE()
	{
		...
		string text = LanguageManager.\u02BA\u02B9\u02C1\u02B9\u02B2\u02BD\u02B2\u02BC\u02B7\u02BA\u02B8().\u02B5\u02BA\u02BE\u02B9\u02BD\u02B3\u02BB\u02B6\u02B8\u02BD\u02C0(SongSelectSearch.\u02BF\u02BE\u02B6\u02BB\u02BF\u02B5\u02B4\u02BD\u02BD\u02BF\u02B5[SongSelectSearch.\u02B7\u02B6\u02B8\u02B7\u02B5\u02BE\u02C0\u02C1\u02B8\u02BE\u02B4]) + "No songs were found!" + u02BF_u02BC_u02B9_u02C1_u02B8_u02C1_u02BF_u02BB_u02BF_u02B7_u02BB.text;
		if (\u02BE\u02B2\u02BD\u02BB\u02BA\u02B6\u02BA\u02BA\u02B7\u02BF\u02BA.\u02BA\u02B5\u02C0\u02BE\u02BC\u02B5\u02BA\u02B2\u02B7\u02C0\u02B3.Contains(text))
		{
			return;
		}
	...
	private void \u02B7\u02BC\u02B6\u02B7\u02BB\u02B7\u02B6\u02BB\u02B5\u02B5\u02C1()
	{
		...
		string text = LanguageManager.\u02B2\u02BE\u02BA\u02B7\u02B4\u02BA\u02BD\u02BE\u02B7\u02B8\u02BE().\u02BB\u02B9\u02BB\u02B8\u02B3\u02B2\u02B5\u02B6\u02B4\u02B2\u02B4(SongSelectSearch.\u02BF\u02BE\u02B6\u02BB\u02BF\u02B5\u02B4\u02BD\u02BD\u02BF\u02B5[SongSelectSearch.\u02B7\u02B6\u02B8\u02B7\u02B5\u02BE\u02C0\u02C1\u02B8\u02BE\u02B4]) + "menu_volume" + u02BF_u02BC_u02B9_u02C1_u02B8_u02C1_u02BF_u02BB_u02BF_u02B7_u02BB.text;
		if (\u02BE\u02B2\u02BD\u02BB\u02BA\u02B6\u02BA\u02BA\u02B7\u02BF\u02BA.\u02BA\u02B5\u02C0\u02BE\u02BC\u02B5\u02BA\u02B2\u02B7\u02C0\u02B3.Contains(text))
		{
			return;
		}
	...
	private void \u02BC\u02B8\u02B9\u02B2\u02BC\u02BD\u02B6\u02B4\u02B3\u02BC\u02C1()
	{
		...
		string text = LanguageManager.\u02B2\u02BE\u02BA\u02B7\u02B4\u02BA\u02BD\u02BE\u02B7\u02B8\u02BE().\u02B5\u02BA\u02BE\u02B9\u02BD\u02B3\u02BB\u02B6\u02B8\u02BD\u02C0(SongSelectSearch.\u02BF\u02BE\u02B6\u02BB\u02BF\u02B5\u02B4\u02BD\u02BD\u02BF\u02B5[SongSelectSearch.\u02B7\u02B6\u02B8\u02B7\u02B5\u02BE\u02C0\u02C1\u02B8\u02BE\u02B4]) + "x86_64" + u02BF_u02BC_u02B9_u02C1_u02B8_u02C1_u02BF_u02BB_u02BF_u02B7_u02BB.text;
		if (\u02BE\u02B2\u02BD\u02BB\u02BA\u02B6\u02BA\u02BA\u02B7\u02BF\u02BA.\u02BA\u02B5\u02C0\u02BE\u02BC\u02B5\u02BA\u02B2\u02B7\u02C0\u02B3.Contains(text))
		{
			return;
		}
	...
	private void \u02B5\u02B8\u02BE\u02BB\u02C1\u02BD\u02B9\u02B9\u02BD\u02B5\u02B6()
	{
		...
		Utf16ValueStringBuilder utf16ValueStringBuilder = ZString.CreateStringBuilder();
		utf16ValueStringBuilder.Append(LanguageManager.instance.GetString("Searching for"));
		utf16ValueStringBuilder.Append(": <color=\"white\"><b>");
		utf16ValueStringBuilder.Append(LanguageManager.instance.GetString(SongSelectSearch.\u02BF\u02BE\u02B6\u02BB\u02BF\u02B5\u02B4\u02BD\u02BD\u02BF\u02B5[SongSelectSearch.\u02B7\u02B6\u02B8\u02B7\u02B5\u02BE\u02C0\u02C1\u02B8\u02BE\u02B4]));
	...
	private void \u02B2\u02BB\u02BE\u02B7\u02B6\u02B8\u02B4\u02B3\u02C1\u02BF\u02BB()
	{
		...
		this.searchText.text = LanguageManager.instance.GetString("Start typing...");
		this.\u02B3\u02BA\u02B9\u02BE\u02BC\u02C1\u02B2\u02BE\u02B2\u02BC\u02BA = true;
	}
	...
	private void \u02BE\u02BC\u02B8\u02BF\u02C0\u02B2\u02BE\u02BD\u02BE\u02BF\u02B2()
	{
		...
		string text = LanguageManager.instance.GetString(SongSelectSearch.\u02BF\u02BE\u02B6\u02BB\u02BF\u02B5\u02B4\u02BD\u02BD\u02BF\u02B5[SongSelectSearch.\u02B7\u02B6\u02B8\u02B7\u02B5\u02BE\u02C0\u02C1\u02B8\u02BE\u02B4]) + ": " + u02BF_u02BC_u02B9_u02C1_u02B8_u02C1_u02BF_u02BB_u02BF_u02B7_u02BB.text;
		if (\u02BE\u02B2\u02BD\u02BB\u02BA\u02B6\u02BA\u02BA\u02B7\u02BF\u02BA.\u02BA\u02B5\u02C0\u02BE\u02BC\u02B5\u02BA\u02B2\u02B7\u02C0\u02B3.Contains(text))
		{
			return;
		}
