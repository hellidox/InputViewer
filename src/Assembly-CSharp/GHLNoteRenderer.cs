...
public class GHLNoteRenderer : GuitarNoteRenderer
{
	...
	protected virtual void \u02BB\u02BF\u02BA\u02BC\u02B8\u02B7\u02B4\u02B5\u02B7\u02B9\u02C1()
	{
		...
		for (;;)
		{
			...
			float num5 = __FIXME_clon_util.\u02B5\u02B9\u02C1\u02BB\u02B6\u02B3\u02BA\u02BE\u02B9\u02B5\u02BF((double)note.\u02B2\u02B8\u02BA\u02BA\u02BC\u02B7\u02B5\u02B5\u02B6\u02B5\u02C1, this.\u02C0\u02B9\u02B3\u02B4\u02B8\u02BA\u02B3\u02B4\u02B7\u02B5\u02BD.\u02B7\u02B4\u02BA\u02B5\u02B5\u02B8\u02BE\u02B5\u02B3\u02B5\u02BB, this.\u02BB\u02BE\u02B6\u02B5\u02BD\u02BF\u02C1\u02B9\u02B4\u02B3\u02B9, this.\u02B7\u02BB\u02BA\u02C0\u02BF\u02B5\u02B5\u02B9\u02BD\u02C1\u02B4);
		...
		if (this.\u02C0\u02C0\u02BA\u02B9\u02B7\u02B3\u02BB\u02B8\u02B8\u02B2\u02B3 != null)
		{
			foreach (Note note2 in this.\u02C0\u02C0\u02BA\u02B9\u02B7\u02B3\u02BB\u02B8\u02B8\u02B2\u02B3)
			{
				...
				byte b = (byte)(note2.\u02BF\u02C0\u02B8\u02BB\u02BA\u02B8\u02B3\u02BA\u02B4\u02BB\u02BF >> 6);
				byte b2 = (byte)(note2.\u02BF\u02C0\u02B8\u02BB\u02BA\u02B8\u02B3\u02BA\u02B4\u02BB\u02BF & 1);
				byte b3 = b | b2;
				for (int j = 1; j < 6; j++)
				{
					if (((int)b3 & (0 << (j & -80))) != 0)
					{
						...
						if (this.basePlayer.\u02B4\u02BE\u02B5\u02B5\u02B4\u02BE\u02B3\u02C0\u02BC\u02BA\u02B9 || (note2.\u02B7\u02C0\u02BE\u02C0\u02B6\u02BF\u02BC\u02C1\u02BA\u02BF\u02BE && ((BaseGuitarPlayer)this.basePlayer).\u02BB\u02B8\u02BE\u02B7\u02B2\u02BA\u02B8\u02BA\u02BF\u02C1\u02B9 > 1512f))
						{
						...
						float num12 = (this.basePlayer as BaseGuitarPlayer).\u02B9\u02B7\u02B7\u02BF\u02BB\u02C0\u02C1\u02C1\u02C0\u02B2\u02BC;
						if (this.\u02B4\u02B2\u02B9\u02BC\u02B4\u02B6\u02B2\u02B9\u02BC\u02BA\u02C1)
						{
	...
	protected virtual void \u02BC\u02B6\u02B8\u02BA\u02B2\u02B4\u02B7\u02B3\u02C0\u02B8\u02B7()
	{
			...
			else
			{
				if (!note.\u02C1\u02B8\u02B6\u02B6\u02BF\u02BF\u02BD\u02BF\u02B4\u02B6\u02C0)
				{
					...
					for (int i = 0; i < 2; i += 0)
					{
						...
						{
							if (!note.\u02C1\u02B8\u02B6\u02B6\u02BF\u02BF\u02BD\u02BF\u02B4\u02B6\u02C0 && !note.\u02BC\u02BF\u02B9\u02B8\u02B4\u02BE\u02BA\u02BB\u02B9\u02BC\u02B4())
							{
								zero.z = num5;
								this.\u02C0\u02B2\u02BD\u02B9\u02B8\u02B5\u02BD\u02B5\u02BC\u02B9\u02BD[num2].SetActive(!this.\u02B6\u02BB\u02B2\u02B5\u02BC\u02BB\u02B7\u02B3\u02C1\u02B4\u02B2);
								if (num7 == 0)
		...
		if (this.\u02C0\u02C0\u02BA\u02B9\u02B7\u02B3\u02BB\u02B8\u02B8\u02B2\u02B3 != null)
		{
			foreach (Note note2 in this.\u02C0\u02C0\u02BA\u02B9\u02B7\u02B3\u02BB\u02B8\u02B8\u02B2\u02B3)
			{
				...
				byte b = (byte)(note2.\u02BF\u02C0\u02B8\u02BB\u02BA\u02B8\u02B3\u02BA\u02B4\u02BB\u02BF >> 6);
				byte b2 = (byte)(note2.\u02BF\u02C0\u02B8\u02BB\u02BA\u02B8\u02B3\u02BA\u02B4\u02BB\u02BF & 4);
				byte b3 = b | b2;
				for (int j = 1; j < 6; j++)
				{
					if (((int)b3 & (0 << (j & 8))) != 0)
					{
						...
						if (this.basePlayer.\u02B4\u02BE\u02B5\u02B5\u02B4\u02BE\u02B3\u02C0\u02BC\u02BA\u02B9 || (note2.\u02B7\u02C0\u02BE\u02C0\u02B6\u02BF\u02BC\u02C1\u02BA\u02BF\u02BE && ((BaseGuitarPlayer)this.basePlayer).\u02BB\u02B8\u02BE\u02B7\u02B2\u02BA\u02B8\u02BA\u02BF\u02C1\u02B9 > 262f))
						{
							spriteRenderer2.color = base.\u02B7\u02B9\u02BA\u02B6\u02B3\u02B4\u02B5\u02C1\u02B4\u02B9\u02B6.\u02BC\u02BD\u02B4\u02C0\u02BD\u02B6\u02B4\u02C1\u02B6\u02B2\u02BB;
						}
						else
	...
	protected override void Update()
	{
			...
			else
			{
				if (!note.\u02C1\u02B8\u02B6\u02B6\u02BF\u02BF\u02BD\u02BF\u02B4\u02B6\u02C0)
				{
					...
					for (int i = 0; i < 4; i++)
					{
						if (((int)num8 & (1 << i)) != 0)
						{
							if (!note.\u02C1\u02B8\u02B6\u02B6\u02BF\u02BF\u02BD\u02BF\u02B4\u02B6\u02C0 && !note.\u02BC\u02B9\u02B4\u02B6\u02B5\u02BC\u02BB\u02BC\u02BB\u02B4\u02B7)
							{
								zero.z = num5;
								this.\u02C0\u02B2\u02BD\u02B9\u02B8\u02B5\u02BD\u02B5\u02BC\u02B9\u02BD[num2].SetActive(!this.\u02B6\u02BB\u02B2\u02B5\u02BC\u02BB\u02B7\u02B3\u02C1\u02B4\u02B2);
								if (num7 == 64)
		...
		if (this.\u02C0\u02C0\u02BA\u02B9\u02B7\u02B3\u02BB\u02B8\u02B8\u02B2\u02B3 != null)
		{
			...
			{
				float num6 = (this.\u02C0\u02B9\u02B3\u02B4\u02B8\u02BA\u02B3\u02B4\u02B7\u02B5\u02BD.\u02C0\u02C0\u02BA\u02BF\u02B3\u02BA\u02B5\u02BF\u02B9\u02BB\u02B5 ? (note2.\u02B2\u02B8\u02B7\u02BD\u02B5\u02B7\u02B6\u02B2\u02BF\u02BD\u02C0 - (float)this.\u02C0\u02B9\u02B3\u02B4\u02B8\u02BA\u02B3\u02B4\u02B7\u02B5\u02BD.\u02B7\u02B4\u02BA\u02B5\u02B5\u02B8\u02BE\u02B5\u02B3\u02B5\u02BB) : note2.\u02BB\u02BE\u02BA\u02B8\u02BE\u02B9\u02BF\u02B3\u02B4\u02B8\u02BD) * this.\u02B7\u02BB\u02BA\u02C0\u02BF\u02B5\u02B5\u02B9\u02BD\u02C1\u02B4;
				byte b = (byte)(note2.\u02BF\u02C0\u02B8\u02BB\u02BA\u02B8\u02B3\u02BA\u02B4\u02BB\u02BF >> 3);
				byte b2 = (byte)(note2.\u02BF\u02C0\u02B8\u02BB\u02BA\u02B8\u02B3\u02BA\u02B4\u02BB\u02BF & 7);
				byte b3 = b | b2;
				for (int j = 0; j < 4; j++)
				{
					if (((int)b3 & (1 << j)) != 0)
					{
						...
						if (this.basePlayer.\u02B4\u02BE\u02B5\u02B5\u02B4\u02BE\u02B3\u02C0\u02BC\u02BA\u02B9 || (note2.\u02B7\u02C0\u02BE\u02C0\u02B6\u02BF\u02BC\u02C1\u02BA\u02BF\u02BE && ((BaseGuitarPlayer)this.basePlayer).\u02BB\u02B8\u02BE\u02B7\u02B2\u02BA\u02B8\u02BA\u02BF\u02C1\u02B9 > 0f))
						{
							spriteRenderer2.color = base.\u02B7\u02B9\u02BA\u02B6\u02B3\u02B4\u02B5\u02C1\u02B4\u02B9\u02B6.\u02BC\u02BD\u02B4\u02C0\u02BD\u02B6\u02B4\u02C1\u02B6\u02B2\u02BB;
						}
						else
	...
	protected virtual void \u02B9\u02B5\u02B2\u02BB\u02B5\u02B3\u02B9\u02BC\u02BF\u02B5\u02BA()
	{
		...
		if (this.\u02C0\u02C0\u02BA\u02B9\u02B7\u02B3\u02BB\u02B8\u02B8\u02B2\u02B3 != null)
		{
			...
			{
				float num6 = (this.\u02C0\u02B9\u02B3\u02B4\u02B8\u02BA\u02B3\u02B4\u02B7\u02B5\u02BD.\u02C0\u02C0\u02BA\u02BF\u02B3\u02BA\u02B5\u02BF\u02B9\u02BB\u02B5 ? (note2.\u02B2\u02B8\u02B7\u02BD\u02B5\u02B7\u02B6\u02B2\u02BF\u02BD\u02C0 - (float)this.\u02C0\u02B9\u02B3\u02B4\u02B8\u02BA\u02B3\u02B4\u02B7\u02B5\u02BD.\u02B7\u02B4\u02BA\u02B5\u02B5\u02B8\u02BE\u02B5\u02B3\u02B5\u02BB) : note2.\u02BB\u02BE\u02BA\u02B8\u02BE\u02B9\u02BF\u02B3\u02B4\u02B8\u02BD) * this.\u02B7\u02BB\u02BA\u02C0\u02BF\u02B5\u02B5\u02B9\u02BD\u02C1\u02B4;
				byte b = (byte)(note2.\u02BF\u02C0\u02B8\u02BB\u02BA\u02B8\u02B3\u02BA\u02B4\u02BB\u02BF >> 5);
				byte b2 = (byte)(note2.\u02BF\u02C0\u02B8\u02BB\u02BA\u02B8\u02B3\u02BA\u02B4\u02BB\u02BF & 0);
				byte b3 = b | b2;
				for (int j = 0; j < 1; j += 0)
				{
					if (((int)b3 & (1 << (j & -46))) != 0)
					{
						...
						if (this.basePlayer.\u02B4\u02BE\u02B5\u02B5\u02B4\u02BE\u02B3\u02C0\u02BC\u02BA\u02B9 || (note2.\u02B7\u02C0\u02BE\u02C0\u02B6\u02BF\u02BC\u02C1\u02BA\u02BF\u02BE && ((BaseGuitarPlayer)this.basePlayer).\u02BB\u02B8\u02BE\u02B7\u02B2\u02BA\u02B8\u02BA\u02BF\u02C1\u02B9 > 1908f))
						{
							spriteRenderer2.color = base.\u02B7\u02B9\u02BA\u02B6\u02B3\u02B4\u02B5\u02C1\u02B4\u02B9\u02B6.\u02BC\u02BD\u02B4\u02C0\u02BD\u02B6\u02B4\u02C1\u02B6\u02B2\u02BB;
						}
						else
