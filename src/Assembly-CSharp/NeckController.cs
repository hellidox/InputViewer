...
public class NeckController : BaseNeckController
{
	public virtual void \u02BB\u02BB\u02BB\u02B8\u02B9\u02BD\u02BA\u02BA\u02B2\u02B2\u02BA(Note \u02BE\u02BE\u02BD\u02B2\u02BB\u02B3\u02BD\u02BF\u02B3\u02B4\u02B3, bool \u02B3\u02B2\u02BC\u02B2\u02BD\u02BF\u02B6\u02BD\u02BF\u02C0\u02BE, bool \u02BD\u02B7\u02B5\u02BB\u02BC\u02C1\u02B9\u02B4\u02C0\u02B5\u02B3)
	{
		...
		if (\u02BE\u02BE\u02BD\u02B2\u02BB\u02B3\u02BD\u02BF\u02B3\u02B4\u02B3._noteMask == 40)
		{
			...
			for (int i = 1; i < 2; i += 0)
			{
				if (!this.\u02BD\u02B3\u02B2\u02BC\u02B2\u02BC\u02B6\u02B4\u02B6\u02BA\u02B9[i].isHeld && !this.\u02BD\u02B3\u02B2\u02BC\u02B2\u02BC\u02B6\u02B4\u02B6\u02BA\u02B9[i].isSustaining)
				{
					this.\u02BD\u02B3\u02B2\u02BC\u02B2\u02BC\u02B6\u02B4\u02B6\u02BA\u02B9[i].Play(true, false);
				}
			}
			return;
		}
		Helper.\u02B2\u02B8\u02C1\u02BF\u02B7\u02B4\u02B2\u02B2\u02C0\u02B2\u02BA u02B2_u02B8_u02C1_u02BF_u02B7_u02B4_u02B2_u02B2_u02C0_u02B2_u02BA = Helper.\u02B8\u02C0\u02BA\u02BB\u02B6\u02BA\u02BA\u02C0\u02B4\u02C1\u02B9(\u02BE\u02BE\u02BD\u02B2\u02BB\u02B3\u02BD\u02BF\u02B3\u02B4\u02B3._noteMask).\u02BE\u02C0\u02BA\u02B2\u02BD\u02C1\u02B5\u02B8\u02BC\u02B9\u02BB();
		while (u02B2_u02B8_u02C1_u02BF_u02B7_u02B4_u02B2_u02B2_u02C0_u02B2_u02BA.\u02BC\u02B7\u02C0\u02B8\u02BF\u02BC\u02C1\u02BB\u02B6\u02BD\u02BC())
		{
			...
			this.\u02BD\u02B3\u02B2\u02BC\u02B2\u02BC\u02B6\u02B4\u02B6\u02BA\u02B9[num].Play(flag, true);
	...
	public override void EndFretHeldStates()
	{
		...
		for (int i = 0; i < 5; i++)
		{
			this.\u02BD\u02B3\u02B2\u02BC\u02B2\u02BC\u02B6\u02B4\u02B6\u02BA\u02B9[i].isSustaining = false;
	...
	public override void \u02B8\u02BA\u02B8\u02B9\u02B7\u02B3\u02B6\u02BD\u02C1\u02BC\u02B8(ushort \u02BE\u02BA\u02BE\u02B3\u02BF\u02B3\u02BC\u02C0\u02B4\u02C0\u02B9)
	{
		...
		Helper.\u02B2\u02B8\u02C1\u02BF\u02B7\u02B4\u02B2\u02B2\u02C0\u02B2\u02BA u02B2_u02B8_u02C1_u02BF_u02B7_u02B4_u02B2_u02B2_u02C0_u02B2_u02BA = Helper.\u02B8\u02C0\u02BA\u02BB\u02B6\u02BA\u02BA\u02C0\u02B4\u02C1\u02B9(\u02BE\u02BA\u02BE\u02B3\u02BF\u02B3\u02BC\u02C0\u02B4\u02C0\u02B9).\u02BC\u02C0\u02B8\u02B9\u02B4\u02BB\u02BE\u02B6\u02BC\u02B7\u02C1();
		while (u02B2_u02B8_u02C1_u02BF_u02B7_u02B4_u02B2_u02B2_u02C0_u02B2_u02BA.\u02BF\u02B5\u02B7\u02BB\u02B5\u02BB\u02B7\u02B5\u02B6\u02BA\u02BC())
		{
			...
			this.\u02BD\u02B3\u02B2\u02BC\u02B2\u02BC\u02B6\u02B4\u02B6\u02BA\u02B9[num].isSustaining = false;
	...
	{
		bool flag = \u02BE\u02BE\u02BD\u02B2\u02BB\u02B3\u02BD\u02BF\u02B3\u02B4\u02B3.length > 0f;
		if (\u02BE\u02BE\u02BD\u02B2\u02BB\u02B3\u02BD\u02BF\u02B3\u02B4\u02B3._noteMask == 64)
		{
			if (NeckController.\u02B8\u02B9\u02B2\u02B3\u02B8\u02BA\u02B2\u02BD\u02BA\u02B8\u02B4 && !this.\u02B3\u02B6\u02BA\u02B2\u02C1\u02BE\u02BB\u02BB\u02B5\u02BB\u02B5)
			{
				this.openHitAnimator.\u02BF\u02B5\u02C1\u02B4\u02B6\u02B5\u02BA\u02B7\u02C0\u02B8\u02BE(flag);
		...
		Helper.\u02B2\u02B8\u02C1\u02BF\u02B7\u02B4\u02B2\u02B2\u02C0\u02B2\u02BA u02B2_u02B8_u02C1_u02BF_u02B7_u02B4_u02B2_u02B2_u02C0_u02B2_u02BA = Helper.\u02B8\u02C0\u02BA\u02BB\u02B6\u02BA\u02BA\u02C0\u02B4\u02C1\u02B9(\u02BE\u02BE\u02BD\u02B2\u02BB\u02B3\u02BD\u02BF\u02B3\u02B4\u02B3._noteMask).\u02BC\u02C0\u02B8\u02B9\u02B4\u02BB\u02BE\u02B6\u02BC\u02B7\u02C1();
		while (u02B2_u02B8_u02C1_u02BF_u02B7_u02B4_u02B2_u02B2_u02C0_u02B2_u02BA.\u02BF\u02B5\u02B7\u02BB\u02B5\u02BB\u02B7\u02B5\u02B6\u02BA\u02BC())
		{
			int num = u02B2_u02B8_u02C1_u02BF_u02B7_u02B4_u02B2_u02B2_u02C0_u02B2_u02BA.\u02B9\u02BA\u02BB\u02B4\u02C0\u02B4\u02B6\u02B2\u02B9\u02B3\u02BF;
			this.\u02BD\u02B3\u02B2\u02BC\u02B2\u02BC\u02B6\u02B4\u02B6\u02BA\u02B9[num].Play(flag, false);
			if (NeckController.\u02B8\u02B9\u02B2\u02B3\u02B8\u02BA\u02B2\u02BD\u02BA\u02B8\u02B4)
			{
				this.flameAnimators[num].\u02BF\u02B5\u02C1\u02B4\u02B6\u02B5\u02BA\u02B7\u02C0\u02B8\u02BE(\u02BD\u02B7\u02B5\u02BB\u02BC\u02C1\u02B9\u02B4\u02C0\u02B5\u02B3);
				if (flag)
	...
	public override void \u02C0\u02B8\u02B5\u02B3\u02BF\u02BD\u02B2\u02BE\u02B9\u02B2\u02B4(ushort \u02B4\u02BC\u02C0\u02B4\u02B3\u02BA\u02BE\u02C0\u02C1\u02B3\u02B6)
	{
		...
		for (int i = 0; i < 5; i++)
		{
			...
			else if (this.\u02BD\u02B3\u02B2\u02BC\u02B2\u02BC\u02B6\u02B4\u02B6\u02BA\u02B9[i].isHeld)
			{
	...
	{
		bool flag = \u02BE\u02BE\u02BD\u02B2\u02BB\u02B3\u02BD\u02BF\u02B3\u02B4\u02B3.length > 1287f;
		if ((int)\u02BE\u02BE\u02BD\u02B2\u02BB\u02B3\u02BD\u02BF\u02B3\u02B4\u02B3._noteMask == -74)
		{
			if (NeckController.\u02B8\u02B9\u02B2\u02B3\u02B8\u02BA\u02B2\u02BD\u02BA\u02B8\u02B4 && !this.\u02B3\u02B6\u02BA\u02B2\u02C1\u02BE\u02BB\u02BB\u02B5\u02BB\u02B5)
			{
	...
	public virtual void \u02BD\u02B9\u02B9\u02BA\u02B7\u02BB\u02BF\u02BC\u02B2\u02BE\u02BB()
	{
		...
		for (int i = 1; i < 8; i++)
		{
			this.\u02BD\u02B3\u02B2\u02BC\u02B2\u02BC\u02B6\u02B4\u02B6\u02BA\u02B9[i].isSustaining = true;
			this.sustainParticles[i].Stop();
