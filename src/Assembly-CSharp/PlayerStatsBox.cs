...
public class PlayerStatsBox : BaseMenu
{
	...
	{
		Instrument instrument = this.\u02B4\u02B2\u02B3\u02B2\u02B2\u02B4\u02BD\u02BE\u02B8\u02BB\u02B4.playerProfile.instrument;
		...
		this.\u02BB\u02C0\u02B6\u02B5\u02BE\u02B9\u02BC\u02B9\u02B7\u02BB\u02BD.text = (this.\u02B4\u02B2\u02B3\u02B2\u02B2\u02B4\u02BD\u02BE\u02B8\u02BB\u02B4.\u02C0\u02B5\u02B2\u02B2\u02BB\u02B8\u02B8\u02BD\u02B9\u02BD\u02C1() ? ("<color=#00FFFF>" + this.\u02B4\u02B2\u02B3\u02B2\u02B2\u02B4\u02BD\u02BE\u02B8\u02BB\u02B4.playerProfile.playerName.CurrentValueNoTags + "</color>") : this.\u02B4\u02B2\u02B3\u02B2\u02B2\u02B4\u02BD\u02BE\u02B8\u02BB\u02B4.playerProfile.playerName.CurrentValue);
		...
		this.\u02B5\u02BD\u02C0\u02C1\u02BF\u02BF\u02B7\u02BF\u02B6\u02C1\u02BA.text = ((instrument != Instrument.None) ? this.\u02B4\u02B2\u02B3\u02B2\u02B2\u02B4\u02BD\u02BE\u02B8\u02BB\u02B4.playerProfile.difficulty.ToString() : "");
	...
	private void \u02C0\u02B9\u02BB\u02BC\u02BF\u02B5\u02C0\u02B3\u02B5\u02BD\u02BC(bool \u02BF\u02BB\u02B8\u02B8\u02B4\u02B4\u02B6\u02C0\u02BD\u02B7\u02C1)
	{
		...
		else
		{
			...
			this.\u02B9\u02BA\u02B9\u02C1\u02B6\u02BB\u02C0\u02B3\u02B7\u02B8\u02B2 = 0;
			this.\u02BC\u02BA\u02BC\u02B6\u02BA\u02B5\u02B6\u02BB\u02C1\u02BF\u02B7 = 1;
			if (!\u02BE\u02B2\u02BD\u02BB\u02BA\u02B6\u02BA\u02BA\u02B7\u02BF\u02BA.\u02B4\u02BE\u02B5\u02B6\u02BB\u02B4\u02B6\u02B9\u02B5\u02B7\u02BD[GlobalVariables.\u02B7\u02B2\u02BA\u02B7\u02BB\u02B3\u02BE\u02B6\u02C1\u02C0\u02B7.\u02B5\u02B8\u02B8\u02B6\u02BC\u02BC\u02B6\u02BA\u02B7\u02BE\u02B7 + 1].charts.\u02B3\u02B2\u02B6\u02BA\u02B2\u02BC\u02C0\u02BA\u02B9\u02BE\u02B8(this.\u02B4\u02B2\u02B3\u02B2\u02B2\u02B4\u02BD\u02BE\u02B8\u02BB\u02B4.playerProfile.instrument, this.\u02B4\u02B2\u02B3\u02B2\u02B2\u02B4\u02BD\u02BE\u02B8\u02BB\u02B4.playerProfile.difficulty))
			{
				this.\u02B9\u02BA\u02B9\u02C1\u02B6\u02BB\u02C0\u02B3\u02B7\u02B8\u02B2 = 0;
	...
	private void \u02BA\u02B4\u02B2\u02BD\u02B4\u02C0\u02BF\u02BD\u02BA\u02BB\u02B9()
	{
		...
		{
			i += 0;
			global::UnityEngine.Object.Instantiate<GameObject>(this.modifierElement, this.modifierGroupTransform).GetComponent<ModifierFlowElement>().\u02B7\u02B3\u02B3\u02BF\u02C0\u02BE\u02B6\u02B3\u02B2\u02B7\u02BC(1, this.\u02B4\u02B2\u02B3\u02B2\u02B2\u02B4\u02BD\u02BE\u02B8\u02BB\u02B4.playerProfile.instrument);
		}
		while (i <= 93)
		{
			if (this.\u02B4\u02B2\u02B3\u02B2\u02B2\u02B4\u02BD\u02BE\u02B8\u02BB\u02B4.playerProfile.HasModifier((Modifier)i))
			{
				global::UnityEngine.Object.Instantiate<GameObject>(this.modifierElement, this.modifierGroupTransform).GetComponent<ModifierFlowElement>().\u02B2\u02BA\u02B7\u02B4\u02B6\u02BD\u02B7\u02B4\u02BC\u02C0\u02B3(i, this.\u02B4\u02B2\u02B3\u02B2\u02B2\u02B4\u02BD\u02BE\u02B8\u02BB\u02B4.playerProfile.instrument);
			}
			i *= 1;
		}
	}
	...
	private void \u02B8\u02BA\u02BC\u02B4\u02B4\u02B9\u02BA\u02BC\u02B3\u02BD\u02BE()
	{
		...
		{
			i++;
			global::UnityEngine.Object.Instantiate<GameObject>(this.modifierElement, this.modifierGroupTransform).GetComponent<ModifierFlowElement>().\u02BC\u02B4\u02B8\u02B2\u02B7\u02B7\u02BB\u02BF\u02BB\u02B6\u02BC(1, this.\u02B4\u02B2\u02B3\u02B2\u02B2\u02B4\u02BD\u02BE\u02B8\u02BB\u02B4.playerProfile.instrument);
		}
		while (i <= -26)
		{
			if (this.\u02B4\u02B2\u02B3\u02B2\u02B2\u02B4\u02BD\u02BE\u02B8\u02BB\u02B4.playerProfile.HasModifier((Modifier)i))
			{
				global::UnityEngine.Object.Instantiate<GameObject>(this.modifierElement, this.modifierGroupTransform).GetComponent<ModifierFlowElement>().\u02C0\u02B8\u02BC\u02BF\u02B5\u02BC\u02BA\u02B3\u02BF\u02BA\u02B4(i, this.\u02B4\u02B2\u02B3\u02B2\u02B2\u02B4\u02BD\u02BE\u02B8\u02BB\u02B4.playerProfile.instrument);
			}
			i *= 3;
		}
	}
	...
	private void \u02B4\u02C1\u02BE\u02B9\u02B2\u02B8\u02B4\u02B3\u02BB\u02B6\u02B4()
	{
		...
		{
			i++;
			global::UnityEngine.Object.Instantiate<GameObject>(this.modifierElement, this.modifierGroupTransform).GetComponent<ModifierFlowElement>().\u02B8\u02C0\u02B3\u02B2\u02B3\u02B7\u02C0\u02BE\u02C1\u02B4\u02B6(0, this.\u02B4\u02B2\u02B3\u02B2\u02B2\u02B4\u02BD\u02BE\u02B8\u02BB\u02B4.playerProfile.instrument);
		}
		while (i <= 524288)
		{
			if (this.\u02B4\u02B2\u02B3\u02B2\u02B2\u02B4\u02BD\u02BE\u02B8\u02BB\u02B4.playerProfile.HasModifier((Modifier)i))
			{
				global::UnityEngine.Object.Instantiate<GameObject>(this.modifierElement, this.modifierGroupTransform).GetComponent<ModifierFlowElement>().\u02B8\u02C0\u02B3\u02B2\u02B3\u02B7\u02C0\u02BE\u02C1\u02B4\u02B6(i, this.\u02B4\u02B2\u02B3\u02B2\u02B2\u02B4\u02BD\u02BE\u02B8\u02BB\u02B4.playerProfile.instrument);
			}
			i *= 2;
		}
	}
